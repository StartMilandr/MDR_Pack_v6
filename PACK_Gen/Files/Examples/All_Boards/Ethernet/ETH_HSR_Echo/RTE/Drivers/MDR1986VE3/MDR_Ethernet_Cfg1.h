...
//  Receiver Options
#define  ETHCFG1_RX_ACCEPT_MULTYCAST           0
#define  ETHCFG1_RX_ACCEPT_BROADCAST           0
#define  ETHCFG1_RX_ACCEPT_UNICAST             1
#define  ETHCFG1_RX_ACCEPT_WITH_ANY_MAC        0
#define  ETHCFG1_RX_ACCEPT_WITH_ERRORS         0
#define  ETHCFG1_RX_ACCEPT_CONTROL_FRAMES      0
#define  ETHCFG1_RX_ACCEPT_LONG_FRAMES         0
#define  ETHCFG1_RX_ACCEPT_SHORT_FRAMES        0
...
#define  ETHCFG1_EVENT_CLR_ON_READ             1
