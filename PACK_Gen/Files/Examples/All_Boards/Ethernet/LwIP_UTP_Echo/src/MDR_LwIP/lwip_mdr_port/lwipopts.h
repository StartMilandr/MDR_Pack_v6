...
//=================   Extra Definitions for second ETH block in 1986VE3 ==============
#define IFNAME0_EX1 'e'
#define IFNAME1_EX1 '2'

// Static IP address - for VE3
#define IP_ADDR0_EX1                IP_ADDR0
#define IP_ADDR1_EX1                IP_ADDR1
#define IP_ADDR2_EX1                IP_ADDR2
#define IP_ADDR3_EX1                IP_ADDR3 + 1
   
/* NET mask*/
#define NETMASK_ADDR0_EX1           NETMASK_ADDR0
#define NETMASK_ADDR1_EX1           NETMASK_ADDR1
#define NETMASK_ADDR2_EX1           NETMASK_ADDR2
#define NETMASK_ADDR3_EX1           NETMASK_ADDR3

/* Gateway address */
#define GW_ADDR0_EX1                GW_ADDR0
#define GW_ADDR1_EX1                GW_ADDR1
#define GW_ADDR2_EX1                GW_ADDR2
#define GW_ADDR3_EX1                GW_ADDR3
