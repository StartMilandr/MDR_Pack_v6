...
void MDR_KX028_InitHGPI(void)
{
  ...
  MDR_KX028_WriteAXI(AXI_HGPI_BASE_ADDR + AXI_GPI_RX_CONFIG,         AXI_GPI_RX_CONFIG_FILL(CFG_HGPI_LMEM_BUF_EN, CFG_HGPI_RX_LMEM_BUF_RETR_COUNT));  //{ 0x00650008, 0x02000001 },
...
{
  MDR_KX028_WriteAXI( MDR_KX028_AxiAddrEGPI[emac] + AXI_GPI_RX_CONFIG,          AXI_GPI_RX_CONFIG_FILL(CFG_EGPI_LMEM_BUF_EN, CFG_EGPI_RX_LMEM_BUF_RETR_COUNT));  // 0x02000001 );
  ...
  MDR_KX028_WriteAXI( MDR_KX028_AxiAddrEGPI[emac] + AXI_GPI_LMEM_SEC_BUF_DATA_OFFSET, 0x00000010 );
...
{
  MDR_KX028_WriteAXI( MDR_KX028_AxiAddrETGPI[emac] + AXI_GPI_RX_CONFIG,         AXI_GPI_RX_CONFIG_FILL(CFG_ETGPI_LMEM_BUF_EN, CFG_EGPI_RX_LMEM_BUF_RETR_COUNT));  //0x02000001 );
  ...
  MDR_KX028_WriteAXI( MDR_KX028_AxiAddrETGPI[emac] + AXI_GPI_LMEM_SEC_BUF_DATA_OFFSET, 0x00000010 );
...
{  
  ...
  MDR_KX028_WriteAXI(AXI_CLASS_HW1_BASE_ADDR + AXI_CLASS_NPU_CTRL, AXI_CLASS_NPU_CTRL_FILL(CFG_HW1_PUNT_PORT,   	  //{ 0x006204FC, 0x01011000 },	//CLASS_NPU_CTRL
          CFG_HW1_Q_NUM_SEL,
          CFG_HW1_PUNT_DIS,
          CFG_HW1_Q_ETGS_COS,
          CFG_HW1_DISCARD_COS
  ...
  MDR_KX028_WriteAXI(AXI_CLASS_HW1_BASE_ADDR + AXI_CLASS_ING_AFULL_THRES, CFG_BUF_WATERMARK_AFULL);                     //{ 0x00620290, BUFFERS_WATERMARK_AFULL },	//CLASS_ING_AFULL_THRES
...
{
  //  TODO merge from home
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_HDR_SIZE,                  0x00000030); //{ 0x00770014, 0x00000030 },
  ...
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_BUS_ACCESS_BASE_ADDR,      0x000000C2); //{ 0x00770258, 0x000000C2 },    
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_GLOBAL_CFG,                0x00000001); //{ 0x007704AC, 0x00000001 },		//CLASS_GLOBAL_CFG
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_GLOBAL_CFG1,               0x00000000); //{ 0x007707E8, 0x00000000 },		//CLASS_GLOBAL_CFG1    
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_SNOOP_SPL_MCAST_MASK1_LSB, 0xFFFFFFFF); //{ 0x00770378, 0xFFFFFFFF },
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_SNOOP_SPL_MCAST_MASK1_MSB, 0x0000FFFF); //{ 0x0077037C, 0x0000FFFF },
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_SNOOP_SPL_MCAST_ADDR1_LSB, 0xC200000E); //{ 0x00770368, 0xC200000E },
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_SNOOP_SPL_MCAST_ADDR1_MSB, 0x00000180); //{ 0x0077036C, 0x00000180 },      
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_PUNT_COS,                  0x00000000); //{ 0x007704C0, 0x00000000 },		//CLASS_PUNT_COS

  MDR_KX028_WriteAXI(AXI_CLASS_HW1_BASE_ADDR + AXI_CLASS_NPU_CTRL, AXI_CLASS_NPU_CTRL_FILL(CFG_HW1_PUNT_PORT,	      //{ 0x007704FC, 0x01011000 },	//CLASS_NPU_CTRL
          CFG_HW1_Q_NUM_SEL,
          CFG_HW1_PUNT_DIS,
          CFG_HW1_Q_ETGS_COS,
          CFG_HW1_DISCARD_COS
          ));  
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_NPU_CTRL1, AXI_CLASS_NPU_CTRL1_FILL(CFG_HW1_PUNT_PORT));	//{ 0x007707F0, 0x00000100 },	//CLASS_NPU_CTRL1	HIF - port 16 (count to 0)
  MDR_KX028_WriteAXI(AXI_CLASS_HW2_BASE_ADDR + AXI_CLASS_ING_AFULL_THRES,  CFG_BUF_WATERMARK_AFULL); //{ 0x00770290, BUFFERS_WATERMARK_AFULL },	//CLASS_ING_AFULL_THRES
...
void MDR_KX028_InitTMU(void)
{
  ...
  //  Address of BMU, where buffer should be freed in case of drop.  
  ...
  //  INQ address of PORT0 is EGPI1, etc
  ...
  //  Addr to access unknown packets through SlaveSPI - for tables learning
  ...
  //  Controls the direct/indirect access to context memory. 0 - indirect, 1 - direct  
