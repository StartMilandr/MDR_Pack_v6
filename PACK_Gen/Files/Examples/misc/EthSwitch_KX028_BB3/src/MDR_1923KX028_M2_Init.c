...
void MDR_KX028_M2_InitBMU1_def(void)
{
...
void MDR_KX028_InitBMU2_def(void)
{
...
{
  MDR_KX028_WriteAXI(MDR_KX028_AxiAddrEMAC[emac] + AXI_EMAC_CTRL, AXI_EMAC_CTRL_PORTS_DIS_Msk);
...
//    
//    { AXI_TMU_BASE_ADDR +  AXI_TMU_PHY16_INQ_ADDR, CBUS_BASE_ADDR | AXI_NEW_PACKET_IN_LMEM_REG_ADDR }, //{ 0x00600240, CBUS_BASE_ADDR | AXI_NEW_PACKET_IN_LMEM_REG_ADDR },        //HGPI ADDRESS IN LMEM
//    
...
//uint32_t KX028_PortOffsStruct1[AXI_CLASS_PORT_COUNT] = {
...
//uint32_t KX028_PortOffsStruct2[AXI_CLASS_PORT_COUNT] = {
