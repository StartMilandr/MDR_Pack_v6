...
//======================  Выбор пинов ======================
  ...
  //  см. MDRB_Basis_v2.h
  const MDR_UART_CfgPinGPIO _pinTX_UART2 = {MDRB_UART2_TX_PD0_Port, MDRB_UART2_TX_PD0_Ind, MDRB_UART2_TX_PD0_Func};
  const MDR_UART_CfgPinGPIO _pinRX_UART2 = {MDRB_UART2_RX_PD1_Port, MDRB_UART2_RX_PD1_Ind, MDRB_UART2_RX_PD1Func};
