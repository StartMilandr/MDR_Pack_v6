#ifndef _MDR_ADC_VE4VKX_DEF_H
#define _MDR_ADC_VE4VKX_DEF_H
...
/* =========================================================  ADC1_Cfg  ======================================================== */
typedef enum {
  MDR_ADC_Ch0 = 0,                         /*!< [0..0] Signal on PC4, Ref-                                                */
  MDR_ADC_Ch1 = 1,                         /*!< [1..1] Signal on PC3, Ref+                                                */
  MDR_ADC_Ch2 = 2,                         /*!< [2..2] Signal on PC2                                                      */
  MDR_ADC_Ch3 = 3,                         /*!< [3..3] Signal on PC1                                                      */
  MDR_ADC_Ch4 = 4,                         /*!< [4..4] Signal on PB9                                                      */
  MDR_ADC_Ch5 = 5,                         /*!< [5..5] Signal on PB8                                                      */
  MDR_ADC_Ch6 = 6,                         /*!< [6..6] Signal on PB7                                                      */
  MDR_ADC_Ch7 = 7,                         /*!< [7..7] Signal on PB6                                                      */
  MDR_ADC_ChTS_Vref = 30,                  /*!< TS_VRef_1.23 : Signal from Thermosensor                                   */
  MDR_ADC_ChTS_Temper = 31                 /*!< TS_Temperature : Signal from Thermosensor                                 */
} MDR_ADC_CHSEL;

#define MDR_ADC_CH_REF_MAX          MDR_ADC_Ch1
#define MDR_ADC_CH_REF_MIN          MDR_ADC_Ch0
#define MDR_ADC_PIN_CHANNEL_COUNT   8

typedef enum {
  ADC_Ch0 = 0,                             /*!< [0..0] Signal on PC4, Ref-                                                */
  ADC_Ch1 = 1,                             /*!< [1..1] Signal on PC3, Ref+                                                */
  ADC_Ch2 = 2,                             /*!< [2..2] Signal on PC2                                                      */
  ADC_Ch3 = 3,                             /*!< [3..3] Signal on PC1                                                      */
  ADC_Ch4 = 4,                             /*!< [4..4] Signal on PB9                                                      */
  ADC_Ch5 = 5,                             /*!< [5..5] Signal on PB8                                                      */
  ADC_Ch6 = 6,                             /*!< [6..6] Signal on PB7                                                      */
  ADC_Ch7 = 7                              /*!< [7..7] Signal on PB6                                                      */
} MDR_ADC_PinChannel;
...
/* ======================================================  ADC_CHSEL  ===================================================== */
typedef struct {
  __IOM MDR_OnOff MDR_ADC_SwCh0  : 1;           /*!< [0..0] Signal on PC4, Ref-                                             */
  __IOM MDR_OnOff MDR_ADC_SwCh1  : 1;           /*!< [1..1] Signal on PC3, Ref+                                             */
  __IOM MDR_OnOff MDR_ADC_SwCh2  : 1;           /*!< [2..2] Signal on PC2                                                   */
  __IOM MDR_OnOff MDR_ADC_SwCh3  : 1;           /*!< [3..3] Signal on PC1                                                   */
  __IOM MDR_OnOff MDR_ADC_SwCh4  : 1;           /*!< [4..4] Signal on PB9                                                   */
  __IOM MDR_OnOff MDR_ADC_SwCh5  : 1;           /*!< [5..5] Signal on PB8                                                   */
  __IOM MDR_OnOff MDR_ADC_SwCh6  : 1;           /*!< [6..6] Signal on PB7                                                   */
  __IOM MDR_OnOff MDR_ADC_SwCh7  : 1;           /*!< [7..7] Signal on PB6                                                   */
  __IM  uint32_t                 : 22;
...
typedef struct {
  MDR_OnOff ADC_SelCh0  : 1;                    /*!< [0..0] Signal on PC4, Ref-                            */
  MDR_OnOff ADC_SelCh1  : 1;                    /*!< [1..1] Signal on PC3, Ref+                            */
  MDR_OnOff ADC_SelCh2  : 1;                    /*!< [2..2] Signal on PC2                                  */
  MDR_OnOff ADC_SelCh3  : 1;                    /*!< [3..3] Signal on PC1                                  */
  MDR_OnOff ADC_SelCh4  : 1;                    /*!< [4..4] Signal on PB9                                  */
  MDR_OnOff ADC_SelCh5  : 1;                    /*!< [5..5] Signal on PB8                                  */
  MDR_OnOff ADC_SelCh6  : 1;                    /*!< [6..6] Signal on PB7                                  */
  MDR_OnOff ADC_SelCh7  : 1;                    /*!< [7..7] Signal on PB6                                  */
  uint32_t              : 24;
