#ifndef _MDR_UART_9BIT_DEFS_H
#define _MDR_UART_9BIT_DEFS_H
...
typedef struct {
  ...
  __IOM MDR_OnOff OE         : 1;            /*!< [12..12] Overrun FIFO_RX                                                  */
  __IM  uint32_t             : 19;
} MDR_UART_DR_Bits;

#define MDR_UART_DR_DATA_Pos             (0UL)                     /*!< MDR_UART1 DR: DATA (Bit 0)                            */
#define MDR_UART_DR_DATA_Msk             (0x1ffUL)                 /*!< MDR_UART1 DR: DATA (Bitfield-Mask: 0xff)              */
#define MDR_UART_DR_FE_Pos               (9UL)                     /*!< MDR_UART1 DR: FE (Bit 8)                              */
#define MDR_UART_DR_FE_Msk               (0x200UL)                 /*!< MDR_UART1 DR: FE (Bitfield-Mask: 0x01)                */
#define MDR_UART_DR_PE_Pos               (10UL)                    /*!< MDR_UART1 DR: PE (Bit 9)                              */
#define MDR_UART_DR_PE_Msk               (0x400UL)                 /*!< MDR_UART1 DR: PE (Bitfield-Mask: 0x01)                */
#define MDR_UART_DR_BE_Pos               (11UL)                    /*!< MDR_UART1 DR: BE (Bit 10)                             */
#define MDR_UART_DR_BE_Msk               (0x800UL)                 /*!< MDR_UART1 DR: BE (Bitfield-Mask: 0x01)                */
#define MDR_UART_DR_OE_Pos               (12UL)                    /*!< MDR_UART1 DR: OE (Bit 11)                             */
#define MDR_UART_DR_OE_Msk               (0x1000UL)                /*!< MDR_UART1 DR: OE (Bitfield-Mask: 0x01)                */
...
typedef struct {
  ...
  __IOM MDR_OnOff     Len9_En    : 1;            /*!< [8..8] Enable 9bit length mode                                       */  
  __IM  uint32_t                 : 23;
} MDR_UART_LCRH_Bits;
...
#define MDR_UART_LCR_H_Len9En_Pos        (8UL)                     /*!< MDR_UART1 LCR_H: SPS (Bit 7)                       */
#define MDR_UART_LCR_H_Len9En_Msk        (0x100UL)                  /*!< MDR_UART1 LCR_H: SPS (Bitfield-Mask: 0x01)         */
...
typedef struct {
  ...
  __IOM MDR_OnOff RX_FNE  : 1;            /*!< [11..11] FIFO_RX not Empty                                                */
  __IOM MDR_OnOff TX_FE   : 1;            /*!< [12..12] FIFO_TX empty                                                    */
  __IOM MDR_OnOff TX_BSY  : 1;            /*!< [13..13] TX data in shift register                                        */  
  __IM  uint32_t          : 18;
} MDR_UART_Event_Bits;
...
#define MDR_UART_EVENT_RX_FNE_Pos      (11UL)                    /*!< MDR_UART1 RIS: RNE_RIS (Bit 11)                       */
#define MDR_UART_EVENT_RX_FNE_Msk      (0x800UL)                 /*!< MDR_UART1 RIS: RNE_RIS (Bitfield-Mask: 0x01)          */
#define MDR_UART_EVENT_TX_FE_Pos       (12UL)                    /*!< MDR_UART1 RIS: TFE_RIS (Bit 12)                       */
#define MDR_UART_EVENT_TX_FE_Msk       (0x1000UL)                /*!< MDR_UART1 RIS: TFE_RIS (Bitfield-Mask: 0x01)          */
#define MDR_UART_EVENT_TX_BSY_Pos      (13UL)                    /*!< MDR_UART1 RIS: TBSY_RIS (Bit 13)                      */
#define MDR_UART_EVENT_TX_BSY_Msk      (0x2000UL)                /*!< MDR_UART1 RIS: TBSY_RIS (Bitfield-Mask: 0x01)         */
