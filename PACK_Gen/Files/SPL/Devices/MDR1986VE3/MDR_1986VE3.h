...
#define   MDR_CLK_EN_ADDR_PORT_G  (uint32_t)&MDR_CLOCK->PER2_CLOCK
#define   MDR_CLK_EN_ADDR_PORT_H  (uint32_t)&MDR_CLOCK->PER2_CLOCK
#define   MDR_CLK_EN_ADDR_PORT_I  (uint32_t)&MDR_CLOCK->PER2_CLOCK
