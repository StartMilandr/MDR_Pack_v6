#ifndef _MDR_RST_VE4_DEFS_H
#define _MDR_RST_VE4_DEFS_H
...
typedef struct {
      ...
      __IOM MDR_OnOff  DMA_CLK_EN    : 1;         /*!< [5..5] DMA Clock Enable                                                   */
      __IOM MDR_OnOff  CMP_CLK_EN    : 1;         /*!< [6..6] CMP Clock Enable                                                   */
      __IOM MDR_OnOff  DAC_CLK_EN    : 1;         /*!< [7..7] DAC Clock Enable                                                   */
...
#define MDR_RST_PER2__DMA_CLK_EN_Pos    (5UL)            /*!< MDR_RST_CLOCK PER2_CLOCK: DMA_CLK_EN (Bit 5)                        */
#define MDR_RST_PER2__DMA_CLK_EN_Msk    (0x20UL)         /*!< MDR_RST_CLOCK PER2_CLOCK: DMA_CLK_EN (Bitfield-Mask: 0x01)          */
#define MDR_RST_PER2__CMP_CLK_EN_Pos    (6UL)            /*!< MDR_RST_CLOCK PER2_CLOCK: CMP_CLK_EN (Bit 6)                        */
#define MDR_RST_PER2__CMP_CLK_EN_Msk    (0x40UL)         /*!< MDR_RST_CLOCK PER2_CLOCK: CMP_CLK_EN (Bitfield-Mask: 0x01)          */
#define MDR_RST_PER2__DAC_CLK_EN_Pos    (7UL)            /*!< MDR_RST_CLOCK PER2_CLOCK: DAC_CLK_EN (Bit 7)                        */
#define MDR_RST_PER2__DAC_CLK_EN_Msk    (0x80UL)         /*!< MDR_RST_CLOCK PER2_CLOCK: DAC_CLK_EN (Bitfield-Mask: 0x01)          */
