#ifndef _MDR_RST_VE9X_DEFS_H
#define _MDR_RST_VE9X_DEFS_H
...
typedef struct {
      ...
      __IOM MDR_OnOff  CPM_CLK_EN      : 1;         /*!< [19..19] Comparator Clock Enable                                      */
      ...
      __IM  uint32_t                   : 1;         /*!< [26..26] Reserved                                                     */
      __IOM MDR_OnOff  BKP_CLK_EN      : 1;         /*!< [27..27] Backup Clock Enable                                          */
      __IM  uint32_t                   : 1;         /*!< [28..28] Reserved                                                     */
      ...
      __IM  uint32_t                   : 1;         /*!< [31..31] Reserved                                                     */
} MDR_RST_PER_Bits;
...
/* =======================================================  CAN_CLOCK  ======================================================= */
typedef struct {
      __IOM MDR_BRG_DIV_128  CAN1_BRG    : 3;     /*!< [2..0] HCLK divider to get CAN1_CLOCK, [/1, /2, /4 .. /128]            */
      __IM  uint32_t                     : 5;
      __IOM MDR_BRG_DIV_128  CAN2_BRG    : 3;     /*!< [10..8] HCLK freq divider to get CAN2_CLOCK, [/1, /2, /4 ../128]       */
      __IM  uint32_t                     : 13;
...
/* ======================================================  UART_CLOCK  ======================================================= */
typedef struct {
      __IOM MDR_BRG_DIV_128  UART1_BRG    : 3;          /*!< [2..0] PER1_C2 freq divider to get UART1_CLOCK, [/1, /2, /4 .. /128]   */
      __IM  uint32_t                      : 5;
      __IOM MDR_BRG_DIV_128  UART2_BRG    : 3;          /*!< [10..8] PER1_C2 freq divider to get UART2_CLOCK, [/1, /2, /4 .. /128]  */
      __IM  uint32_t                      : 13;
