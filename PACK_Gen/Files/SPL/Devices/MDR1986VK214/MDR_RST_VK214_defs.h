#ifndef _MDR_RST_VK214_DEFS_H
#define _MDR_RST_VK214_DEFS_H
...
typedef struct {
      ...
      __IOM MDR_CLK_SEL_PER   UART1_C2_SEL : 2;           /*!< [9..8] UART1_C2 mux freq select                                  */
      __IOM MDR_CLK_SEL_PER   UART2_C2_SEL : 2;           /*!< [11..10] UART2_C2 mux freq select                                */
      __IOM MDR_CLK_SEL_PER   SSP2_C2_SEL  : 2;           /*!< [13..12] SSP2_C2 mux freq select                                 */
      __IM  uint32_t                       : 18;
} MDR_RST_PER1_Bits;
...
#define MDR_RST_PER1__TIM2_C2_SEL_Pos  (6UL)              /*!< MDR_RST_CLOCK PER1_CLOCK: TIM2_C2_SEL (Bit 6)                    */
#define MDR_RST_PER1__TIM2_C2_SEL_Msk  (0xc0UL)           /*!< MDR_RST_CLOCK PER1_CLOCK: TIM2_C2_SEL (Bitfield-Mask: 0x03)      */
#define MDR_RST_PER1__UART1_C2_SEL_Pos (8UL)              /*!< MDR_RST_CLOCK PER1_CLOCK: UART1_C2_SEL (Bit 8)                   */
#define MDR_RST_PER1__UART1_C2_SEL_Msk (0x300UL)          /*!< MDR_RST_CLOCK PER1_CLOCK: UART1_C2_SEL (Bitfield-Mask: 0x03)     */
#define MDR_RST_PER1__UART2_C2_SEL_Pos (10UL)             /*!< MDR_RST_CLOCK PER1_CLOCK: UART2_C2_SEL (Bit 10)                  */
#define MDR_RST_PER1__UART2_C2_SEL_Msk (0xc00UL)          /*!< MDR_RST_CLOCK PER1_CLOCK: UART2_C2_SEL (Bitfield-Mask: 0x03)     */
#define MDR_RST_PER1__SSP2_C2_SEL_Pos  (12UL)             /*!< MDR_RST_CLOCK PER1_CLOCK: SSP2_C2_SEL (Bit 12)                   */
#define MDR_RST_PER1__SSP2_C2_SEL_Msk  (0x3000UL)         /*!< MDR_RST_CLOCK PER1_CLOCK: SSP2_C2_SEL (Bitfield-Mask: 0x03)      */
...
typedef struct {
      ...
      __IM  uint32_t                 : 1;         /*!< [5..5]                                                                    */
      __IOM MDR_OnOff  I2C_CLK_EN    : 1;         /*!< [6..6] I2C Clock Enable                                                   */
      __IOM MDR_OnOff  LCD_CLK_EN    : 1;         /*!< [7..7] LCD Clock Enable                                                   */
...
#define MDR_RST_PER2__LCD_CLK_EN_Msk    (0x80UL)         /*!< MDR_RST_CLOCK PER2_CLOCK: LCD_CLK_EN (Bitfield-Mask: 0x01)          */
