...
//#endif
void TIMER_SetCounter(MDR_TIMER_TypeDef* TIMERx, uint_tim Counter)
{
  /* Check the parameters */
  assert_param(IS_TIMER_ALL_PERIPH(TIMERx));
...
//#endif
void TIMER_SetCntAutoreload(MDR_TIMER_TypeDef* TIMERx, uint_tim Autoreload)
{
  /* Check the parameters */
  assert_param(IS_TIMER_ALL_PERIPH(TIMERx));
...
//#endif
void TIMER_CntAutoreloadConfig(MDR_TIMER_TypeDef* TIMERx, uint_tim Autoreload, uint32_t UpdateMode)
{
  uint32_t tmpreg_CNTRL;
...
//#endif
uint_tim TIMER_GetCounter(MDR_TIMER_TypeDef* TIMERx)
{
  /* Check the parameters */
  assert_param(IS_TIMER_ALL_PERIPH(TIMERx));
...
//#endif
void TIMER_SetChnCompare(MDR_TIMER_TypeDef* TIMERx, uint32_t Channel, uint_tim Compare)
{
...
//#endif
void TIMER_SetChnCompare1(MDR_TIMER_TypeDef* TIMERx, uint32_t Channel, uint_tim Compare)
{
...
//#endif
void TIMER_ChnCompareConfig(MDR_TIMER_TypeDef* TIMERx, uint32_t Channel, uint_tim Compare, uint32_t UpdateMode)
{
...
//#endif
void TIMER_ChnCompare1Config(MDR_TIMER_TypeDef* TIMERx, uint32_t Channel, uint_tim Compare, uint32_t UpdateMode)
{
  __IO uint32_t *tmpreg_CNTRL2x;
  __IO uint32_t *tmpreg_CCR1x;
  uint32_t tmpreg_CNTRL2;
...
//#endif
uint_tim TIMER_GetChnCapture(MDR_TIMER_TypeDef* TIMERx, uint32_t Channel)
{
  __IO uint32_t *tmpreg_CCRx;
  uint32_t tmpreg;
...
//#endif
uint_tim TIMER_GetChnCapture1(MDR_TIMER_TypeDef* TIMERx, uint32_t Channel)
{
  __IO uint32_t *tmpreg_CCR1x;
  uint32_t tmpreg;
...
void TIMER_BRGInit ( MDR_TIMER_TypeDef* TIMERx, uint32_t TIMER_BRG ) {
	...
	tmpreg = MDR_CLOCK->TIM_CLOCK;

	if (TIMERx == MDR_TIMER1) {
		tmpreg &= ~MDR_RST_TIM__TIM1_BRG_Msk;
		tmpreg |= TIMER_BRG << MDR_RST_TIM__TIM1_BRG_Pos;
		tmpreg |= MDR_RST_TIM__TIM1_CLK_EN_Msk;
	}
	else
		if (TIMERx == MDR_TIMER2) {
			tmpreg &= ~MDR_RST_TIM__TIM2_BRG_Msk;
			tmpreg |= TIMER_BRG << MDR_RST_TIM__TIM2_BRG_Pos;
			tmpreg |= MDR_RST_TIM__TIM2_CLK_EN_Msk;
		}

	MDR_CLOCK->TIM_CLOCK = tmpreg;
}
