#ifndef _MDR_RST_CLOCK_DefsVK14_H
#define _MDR_RST_CLOCK_DefsVK14_H
...
//  Подавление warnings компилятора V6 о добавлении  "пустот" в структуры
  ...
  #define  MDR_CPU_CFG_PLL_HSI_DV_DEF(N, Q, DV, lowRI, div2)  {.freqTrim  = HSI_FREQ_TRIM,  \
                                                                       .selDiv2                = div2,            \
  ...
  #define  MDR_CPU_CFG_PLL_HSI_DEF(N, Q, DV, lowRI)         MDR_CPU_CFG_PLL_HSI_DV_DEF(N, Q, DV, lowRI, false)
  #define  MDR_CPU_CFG_PLL_HSI_DIV2_DEF(N, Q, DV, lowRI)    MDR_CPU_CFG_PLL_HSI_DV_DEF(N, Q, DV, lowRI, true)
  ...
  #define  MDR_CPU_CFG_PLL_HSE_SRC_DV_DEF(src, N, Q, DV, lowRI, div2)    {.freqSource  = (src),  \
                                                                         .selDiv2                = div2,            \
  ...
  #define   MDR_CPU_CFG_PLL_HSE_SRC_DEF(src, N, Q, DV, lowRI)         MDR_CPU_CFG_PLL_HSE_SRC_DV_DEF(src, N, Q, DV, lowRI, false)
  #define   MDR_CPU_CFG_PLL_HSE_DIV2_SRC_DEF(src, N, Q, DV, lowRI)    MDR_CPU_CFG_PLL_HSE_SRC_DV_DEF(src, N, Q, DV, lowRI, true)
                                                                         
  #define  MDR_CPU_CFG_PLL_HSE_RES_DEF(N, Q, DV, lowRI)          MDR_CPU_CFG_PLL_HSE_SRC_DEF(MDR_CLK_Resonator, N, Q, DV, lowRI)
  #define  MDR_CPU_CFG_PLL_HSE_GEN_DEF(N, Q, DV, lowRI)          MDR_CPU_CFG_PLL_HSE_SRC_DEF(MDR_CLK_Generator, N, Q, DV, lowRI)
  #define  MDR_CPU_CFG_PLL_HSE_DIV2_RES_DEF(N, Q, DV, lowRI)     MDR_CPU_CFG_PLL_HSE_DIV2_SRC_DEF(MDR_CLK_Resonator, N, Q, DV, lowRI)
  #define  MDR_CPU_CFG_PLL_HSE_DIV2_GEN_DEF(N, Q, DV, lowRI)     MDR_CPU_CFG_PLL_HSE_DIV2_SRC_DEF(MDR_CLK_Generator, N, Q, DV, lowRI)  
  
#if defined(__ARMCC_VERSION) && (__ARMCC_VERSION >= 6010050)
  #pragma clang diagnostic pop  
#endif  

#endif //  _MDR_RST_CLOCK_DefsVK14_H
