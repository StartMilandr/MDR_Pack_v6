 ...
 * @note     Generated by SVDConv V3.3.18 on Wednesday, 23.10.2019 11:19:27
 *           from File '../_src/MDR1901VC1.svd',
 *           last modified on Wednesday, 23.10.2019 08:19:19
 */
...
typedef struct {                                /*!< (@ 0x40020000) MDR_RST_CLOCK Structure                                    */
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t PLL_DSP_RDY : 1;           /*!< [3..3] DSP PLL ready                                                      */
    } CLOCK_STATUS_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t            : 4;
      __IOM uint32_t PLL_DSP_ON : 1;            /*!< [16..16] PLL DSP Enable                                                   */
      __IOM uint32_t PLL_DSP_PLD : 1;           /*!< [17..17] PLL DSP Restart                                                  */
      __IM  uint32_t            : 2;
      __IOM uint32_t PLL_DSP_MUL : 4;           /*!< [23..20] PLL DSP Mul, [x2 .. x16]                                         */
    } PLL_CONTROL_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t SSP3_CLK_EN : 1;           /*!< [0..0] SSP3 Clock Enable                                                  */
      __IOM uint32_t SSP4_CLK_EN : 1;           /*!< [1..1] SSP4 Clock Enable                                                  */
      ...
      __IOM uint32_t SDIO_CLK_EN : 1;           /*!< [9..9] SDIO Clock Enable                                                  */
      __IOM uint32_t I2C_CLK_EN : 1;            /*!< [10..10] I2C Clock Enable                                                 */
      ...
      __IOM uint32_t CMP_CLK_EN : 1;            /*!< [19..19] Comparator Clock Enable                                          */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t UART2_BRG  : 3;            /*!< [10..8] HCLK freq divider to get UART2_CLOCK, [/1, /2, /4 ..
                                                     /128]                                                                     */
      __IM  uint32_t            : 5;
      __IOM uint32_t UART3_BRG  : 3;            /*!< [18..16] HCLK freq divider to get UART3_CLOCK, [/1, /2, /4 ..
                                                     /128]                                                                     */
      __IM  uint32_t            : 5;
      __IOM uint32_t UART1_CLK_EN : 1;          /*!< [24..24] UART1_CLOCK enable                                               */
      __IOM uint32_t UART2_CLK_EN : 1;          /*!< [25..25] UART2_CLOCK enable                                               */
      __IOM uint32_t UART3_CLK_EN : 1;          /*!< [26..26] UART3_CLOCK enable                                               */
    } UART_CLOCK_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t DSP_C1_SEL : 2;            /*!< [1..0] DSP_C1 mux freq select                                             */
      __IOM uint32_t DSP_C2_SEL : 1;            /*!< [2..2] DSP_C2 mux freq select                                             */
      __IM  uint32_t            : 1;
      __IOM uint32_t DSP_C3_SEL : 1;            /*!< [4..4] DSP_C3 Input Select                                                */
      __IM  uint32_t            : 3;
      __IOM uint32_t DSP_EN     : 1;            /*!< [8..8] DSP Clock Enable                                                   */
    } DSP_CLOCK_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t SSP4_BRG   : 3;            /*!< [2..0] HCLK freq divider to get SSP4_CLOCK, [/1, /2, /4 .. /128]          */
      __IM  uint32_t            : 21;
      __IOM uint32_t SSP4_CLK_EN : 1;           /*!< [24..24] SSP4 Clock Enable                                                */
    } SSP_CLOCK2_b;
  } ;
  
  union {
    __IOM uint32_t DSP_CONTROL_STATUS;          /*!< (@ 0x00000038) DSP Control and Status register                            */
    
    struct {
      __IOM uint32_t RST_DSP    : 1;            /*!< [0..0] Reset DSP block                                                    */
      __IOM uint32_t RST_DSP_CPU : 1;           /*!< [1..1] Reset DSP Core                                                     */
      __IOM uint32_t RST_DSP_MEM : 1;           /*!< [2..2] Reset DSP Memory Blocks                                            */
      __IOM uint32_t RST_DSP_PER : 1;           /*!< [3..3] Reset DSP Peripherial Blocks                                       */
      __IOM uint32_t HOLD       : 1;            /*!< [4..4] Call to stop DSP command sequencer                                 */
      __IOM uint32_t BIO        : 1;            /*!< [5..5] Flag from RISC to DSP Core                                         */
      __IOM uint32_t XF_EN      : 1;            /*!< [6..6] Output flag XF to PA[15] pin                                       */
      __IM  uint32_t            : 1;
      __IOM uint32_t XF         : 1;            /*!< [8..8] Flag from DSP to RISC core                                         */
      __IM  uint32_t HOLDA      : 1;            /*!< [9..9] DSP Command Sequencer status                                       */
      __IM  uint32_t IDLE       : 2;            /*!< [11..10] DSP Command Sequencer status                                     */
      __IM  uint32_t            : 2;
      __IM  uint32_t BRTRD      : 1;            /*!< [14..14] RISC - DSP bridge transfer status                                */
      __IOM uint32_t RD_BUFF_EN : 1;            /*!< [15..15] Pre-read DSP Addr space                                          */
    } DSP_CONTROL_STATUS_b;
  } ;
} MDR_RST_CLOCK_Type;                           /*!< Size = 60 (0x3c)                                                          */
...
/**
  * @brief I2C Controler (MDR_I2C)
  */

typedef struct {                                /*!< (@ 0x40050000) MDR_I2C Structure                                          */
  
  union {
    __IOM uint32_t PRL;                         /*!< (@ 0x00000000) BitRate Div[7:0] of HCLK                                   */
    
    struct {
      __IOM uint32_t PRL        : 8;            /*!< [7..0] Div[7:0] of HCLK                                                   */
    } PRL_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t PRH        : 8;            /*!< [7..0] Div[15:8] of HCLK                                                  */
    } PRH_b;
  } ;
  ...
  union {
    ...
    struct {
      __IM  uint32_t            : 5;
      __IOM uint32_t S_I2C      : 1;            /*!< [5..5] Speed range of I2C                                                 */
      __IOM uint32_t EN_INT     : 1;            /*!< [6..6] Enable IRQ                                                         */
      __IOM uint32_t EN_I2C     : 1;            /*!< [7..7] Enable                                                             */
    } CTR_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t DATA       : 8;            /*!< [7..0] Received Byte                                                      */
    } RXD_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t INT        : 1;            /*!< [0..0] IRQ Event Flag                                                     */
      __IOM uint32_t TR_Prog    : 1;            /*!< [1..1] Transfering status                                                 */
      __IM  uint32_t            : 3;
      __IOM uint32_t Lost_ARB   : 1;            /*!< [5..5] Lost arbitrage                                                     */
      __IOM uint32_t BUSY       : 1;            /*!< [6..6] Line Busy                                                          */
      __IOM uint32_t RX_ACK     : 1;            /*!< [7..7] ACK Status                                                         */
    } STA_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t DATA       : 8;            /*!< [7..0] Send Byte                                                          */
    } TXD_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t CLR_INT    : 1;            /*!< [0..0] Clear IRQ Event                                                    */
      __IM  uint32_t            : 2;
      __IOM uint32_t Send_ACK   : 1;            /*!< [3..3] Send ACK command                                                   */
      __IOM uint32_t Start_Write : 1;           /*!< [4..4] Start Writing transfer                                             */
      __IOM uint32_t Start_Read : 1;            /*!< [5..5] Start Reading transfer                                             */
      __IOM uint32_t Send_Stop  : 1;            /*!< [6..6] Send Stop command                                                  */
      __IOM uint32_t Send_Start : 1;            /*!< [7..7] Send Start command                                                 */
    } CMD_b;
  } ;
...
typedef struct {                                /*!< (@ 0x40058000) MDR_Power Structure                                        */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PVDEN      : 1;            /*!< [0..0] PVD Enable                                                         */
...
typedef struct {                                /*!< (@ 0x40088000) MDR_ADC Structure                                          */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t SYNC_CONV  : 1;            /*!< [16..16] ADC1 and ADC2 sync measurement                                   */
      ...
      __IOM uint32_t TR         : 4;            /*!< [24..21] Trim Vref from Thermosensor                                      */
      __IOM uint32_t Delay_GO   : 3;            /*!< [27..25] Delay after channels switching in CPU_CLK                        */
      __IOM uint32_t Delay_ADC  : 4;            /*!< [31..28] Delay between ADC1 and ADC2 start                                */
    } ADC1_Cfg_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t ADC2_OP    : 1;            /*!< [18..18] ADC2 Setpoint Vref source                                        */
      __IM  uint32_t            : 6;
      __IOM uint32_t Delay_GO   : 3;            /*!< [27..25] Delay after channels switching in CPU_CLK                        */
    } ADC2_Cfg_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t Channel_8  : 1;            /*!< [8..8] Signal on PD9                                                      */
      __IOM uint32_t Channel_9  : 1;            /*!< [9..9] Signal on PD10                                                     */
      __IOM uint32_t Channel_10 : 1;            /*!< [10..10] Signal on PD11                                                   */
      __IOM uint32_t Channel_11 : 1;            /*!< [11..11] Signal on PD12                                                   */
      __IOM uint32_t Channel_12 : 1;            /*!< [12..12] Signal on PD13                                                   */
      __IOM uint32_t Channel_13 : 1;            /*!< [13..13] Signal on PD14                                                   */
      __IOM uint32_t Channel_14 : 1;            /*!< [14..14] Signal on PD11                                                   */
      __IOM uint32_t Channel_15 : 1;            /*!< [15..15] Signal on PD12                                                   */
      __IM  uint32_t            : 14;
...
typedef struct {                                /*!< (@ 0x400D8000) MDR_BKP Structure                                          */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t MODE       : 3;            /*!< [14..12] Bootloading Mode                                                 */
    } REG_0E_b;
  } ;
...
#define MDR_I2C_BASE                0x40050000UL
...
#define MDR_UART3_BASE              0x400D0000UL
...
#define MDR_SSP3_BASE               0x40000000UL
#define MDR_SSP4_BASE               0x40008000UL
...
#define MDR_I2C                     ((MDR_I2C_Type*)           MDR_I2C_BASE)
...
#define MDR_UART3                   ((MDR_UART1_Type*)         MDR_UART3_BASE)
...
#define MDR_RST_CLOCK_CLOCK_STATUS_PLL_DSP_RDY_Pos (3UL)            /*!< MDR_RST_CLOCK CLOCK_STATUS: PLL_DSP_RDY (Bit 3)       */
#define MDR_RST_CLOCK_CLOCK_STATUS_PLL_DSP_RDY_Msk (0x8UL)          /*!< MDR_RST_CLOCK CLOCK_STATUS: PLL_DSP_RDY (Bitfield-Mask: 0x01) */
/* ======================================================  PLL_CONTROL  ====================================================== */
...
#define MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_ON_Pos (16UL)             /*!< MDR_RST_CLOCK PLL_CONTROL: PLL_DSP_ON (Bit 16)        */
#define MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_ON_Msk (0x10000UL)        /*!< MDR_RST_CLOCK PLL_CONTROL: PLL_DSP_ON (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_PLD_Pos (17UL)            /*!< MDR_RST_CLOCK PLL_CONTROL: PLL_DSP_PLD (Bit 17)       */
#define MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_PLD_Msk (0x20000UL)       /*!< MDR_RST_CLOCK PLL_CONTROL: PLL_DSP_PLD (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_Pos (20UL)            /*!< MDR_RST_CLOCK PLL_CONTROL: PLL_DSP_MUL (Bit 20)       */
#define MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_Msk (0xf00000UL)      /*!< MDR_RST_CLOCK PLL_CONTROL: PLL_DSP_MUL (Bitfield-Mask: 0x0f) */
/* ======================================================  HS_CONTROL  ======================================================= */
...
/* =======================================================  PER_CLOCK  ======================================================= */
#define MDR_RST_CLOCK_PER_CLOCK_SSP3_CLK_EN_Pos (0UL)               /*!< MDR_RST_CLOCK PER_CLOCK: SSP3_CLK_EN (Bit 0)          */
#define MDR_RST_CLOCK_PER_CLOCK_SSP3_CLK_EN_Msk (0x1UL)             /*!< MDR_RST_CLOCK PER_CLOCK: SSP3_CLK_EN (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_PER_CLOCK_SSP4_CLK_EN_Pos (1UL)               /*!< MDR_RST_CLOCK PER_CLOCK: SSP4_CLK_EN (Bit 1)          */
#define MDR_RST_CLOCK_PER_CLOCK_SSP4_CLK_EN_Msk (0x2UL)             /*!< MDR_RST_CLOCK PER_CLOCK: SSP4_CLK_EN (Bitfield-Mask: 0x01) */
...
#define MDR_RST_CLOCK_PER_CLOCK_SDIO_CLK_EN_Pos (9UL)               /*!< MDR_RST_CLOCK PER_CLOCK: SDIO_CLK_EN (Bit 9)          */
#define MDR_RST_CLOCK_PER_CLOCK_SDIO_CLK_EN_Msk (0x200UL)           /*!< MDR_RST_CLOCK PER_CLOCK: SDIO_CLK_EN (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_PER_CLOCK_I2C_CLK_EN_Pos (10UL)               /*!< MDR_RST_CLOCK PER_CLOCK: I2C_CLK_EN (Bit 10)          */
#define MDR_RST_CLOCK_PER_CLOCK_I2C_CLK_EN_Msk (0x400UL)            /*!< MDR_RST_CLOCK PER_CLOCK: I2C_CLK_EN (Bitfield-Mask: 0x01) */
...
#define MDR_RST_CLOCK_PER_CLOCK_CMP_CLK_EN_Pos (19UL)               /*!< MDR_RST_CLOCK PER_CLOCK: CMP_CLK_EN (Bit 19)          */
#define MDR_RST_CLOCK_PER_CLOCK_CMP_CLK_EN_Msk (0x80000UL)          /*!< MDR_RST_CLOCK PER_CLOCK: CMP_CLK_EN (Bitfield-Mask: 0x01) */
...
#define MDR_RST_CLOCK_PER_CLOCK_UART3_CLK_EN_Pos (26UL)             /*!< MDR_RST_CLOCK PER_CLOCK: UART3_CLK_EN (Bit 26)        */
#define MDR_RST_CLOCK_PER_CLOCK_UART3_CLK_EN_Msk (0x4000000UL)      /*!< MDR_RST_CLOCK PER_CLOCK: UART3_CLK_EN (Bitfield-Mask: 0x01) */
...
#define MDR_RST_CLOCK_PER_CLOCK_AUC_CLK_EN_Pos (28UL)               /*!< MDR_RST_CLOCK PER_CLOCK: AUC_CLK_EN (Bit 28)          */
#define MDR_RST_CLOCK_PER_CLOCK_AUC_CLK_EN_Msk (0x10000000UL)       /*!< MDR_RST_CLOCK PER_CLOCK: AUC_CLK_EN (Bitfield-Mask: 0x01) */
...
#define MDR_RST_CLOCK_PER_CLOCK_CRYPTO_CLK_EN_Pos (31UL)            /*!< MDR_RST_CLOCK PER_CLOCK: CRYPTO_CLK_EN (Bit 31)       */
#define MDR_RST_CLOCK_PER_CLOCK_CRYPTO_CLK_EN_Msk (0x80000000UL)    /*!< MDR_RST_CLOCK PER_CLOCK: CRYPTO_CLK_EN (Bitfield-Mask: 0x01) */
/* =======================================================  TIM_CLOCK  ======================================================= */
...
#define MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_Pos (16UL)               /*!< MDR_RST_CLOCK UART_CLOCK: UART3_BRG (Bit 16)          */
#define MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_Msk (0x70000UL)          /*!< MDR_RST_CLOCK UART_CLOCK: UART3_BRG (Bitfield-Mask: 0x07) */
...
#define MDR_RST_CLOCK_UART_CLOCK_UART3_CLK_EN_Pos (26UL)            /*!< MDR_RST_CLOCK UART_CLOCK: UART3_CLK_EN (Bit 26)       */
#define MDR_RST_CLOCK_UART_CLOCK_UART3_CLK_EN_Msk (0x4000000UL)     /*!< MDR_RST_CLOCK UART_CLOCK: UART3_CLK_EN (Bitfield-Mask: 0x01) */
/* =======================================================  SSP_CLOCK  ======================================================= */
...
/* =======================================================  DSP_CLOCK  ======================================================= */
#define MDR_RST_CLOCK_DSP_CLOCK_DSP_C1_SEL_Pos (0UL)                /*!< MDR_RST_CLOCK DSP_CLOCK: DSP_C1_SEL (Bit 0)           */
#define MDR_RST_CLOCK_DSP_CLOCK_DSP_C1_SEL_Msk (0x3UL)              /*!< MDR_RST_CLOCK DSP_CLOCK: DSP_C1_SEL (Bitfield-Mask: 0x03) */
#define MDR_RST_CLOCK_DSP_CLOCK_DSP_C2_SEL_Pos (2UL)                /*!< MDR_RST_CLOCK DSP_CLOCK: DSP_C2_SEL (Bit 2)           */
#define MDR_RST_CLOCK_DSP_CLOCK_DSP_C2_SEL_Msk (0x4UL)              /*!< MDR_RST_CLOCK DSP_CLOCK: DSP_C2_SEL (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CLOCK_DSP_C3_SEL_Pos (4UL)                /*!< MDR_RST_CLOCK DSP_CLOCK: DSP_C3_SEL (Bit 4)           */
#define MDR_RST_CLOCK_DSP_CLOCK_DSP_C3_SEL_Msk (0x10UL)             /*!< MDR_RST_CLOCK DSP_CLOCK: DSP_C3_SEL (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CLOCK_DSP_EN_Pos (8UL)                    /*!< MDR_RST_CLOCK DSP_CLOCK: DSP_EN (Bit 8)               */
#define MDR_RST_CLOCK_DSP_CLOCK_DSP_EN_Msk (0x100UL)                /*!< MDR_RST_CLOCK DSP_CLOCK: DSP_EN (Bitfield-Mask: 0x01) */
/* ======================================================  SSP_CLOCK2  ======================================================= */
#define MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_Pos (0UL)                 /*!< MDR_RST_CLOCK SSP_CLOCK2: SSP4_BRG (Bit 0)            */
#define MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_Msk (0x7UL)               /*!< MDR_RST_CLOCK SSP_CLOCK2: SSP4_BRG (Bitfield-Mask: 0x07) */
#define MDR_RST_CLOCK_SSP_CLOCK2_SSP4_CLK_EN_Pos (24UL)             /*!< MDR_RST_CLOCK SSP_CLOCK2: SSP4_CLK_EN (Bit 24)        */
#define MDR_RST_CLOCK_SSP_CLOCK2_SSP4_CLK_EN_Msk (0x1000000UL)      /*!< MDR_RST_CLOCK SSP_CLOCK2: SSP4_CLK_EN (Bitfield-Mask: 0x01) */
/* ==================================================  DSP_CONTROL_STATUS  =================================================== */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_Pos (0UL)          /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RST_DSP (Bit 0)     */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_Msk (0x1UL)        /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RST_DSP (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_CPU_Pos (1UL)      /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RST_DSP_CPU (Bit 1) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_CPU_Msk (0x2UL)    /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RST_DSP_CPU (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_MEM_Pos (2UL)      /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RST_DSP_MEM (Bit 2) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_MEM_Msk (0x4UL)    /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RST_DSP_MEM (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_PER_Pos (3UL)      /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RST_DSP_PER (Bit 3) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_PER_Msk (0x8UL)    /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RST_DSP_PER (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_HOLD_Pos (4UL)             /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: HOLD (Bit 4)        */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_HOLD_Msk (0x10UL)          /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: HOLD (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_BIO_Pos (5UL)              /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: BIO (Bit 5)         */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_BIO_Msk (0x20UL)           /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: BIO (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_XF_EN_Pos (6UL)            /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: XF_EN (Bit 6)       */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_XF_EN_Msk (0x40UL)         /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: XF_EN (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_XF_Pos (8UL)               /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: XF (Bit 8)          */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_XF_Msk (0x100UL)           /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: XF (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_HOLDA_Pos (9UL)            /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: HOLDA (Bit 9)       */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_HOLDA_Msk (0x200UL)        /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: HOLDA (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_IDLE_Pos (10UL)            /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: IDLE (Bit 10)       */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_IDLE_Msk (0xc00UL)         /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: IDLE (Bitfield-Mask: 0x03) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_BRTRD_Pos (14UL)           /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: BRTRD (Bit 14)      */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_BRTRD_Msk (0x4000UL)       /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: BRTRD (Bitfield-Mask: 0x01) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RD_BUFF_EN_Pos (15UL)      /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RD_BUFF_EN (Bit 15) */
#define MDR_RST_CLOCK_DSP_CONTROL_STATUS_RD_BUFF_EN_Msk (0x8000UL)  /*!< MDR_RST_CLOCK DSP_CONTROL_STATUS: RD_BUFF_EN (Bitfield-Mask: 0x01) */
...
/* ==========================================================  TXD  ========================================================== */
#define MDR_I2C_TXD_DATA_Pos              (0UL)                     /*!< MDR_I2C TXD: DATA (Bit 0)                             */
#define MDR_I2C_TXD_DATA_Msk              (0xffUL)                  /*!< MDR_I2C TXD: DATA (Bitfield-Mask: 0xff)               */
/* ==========================================================  CMD  ========================================================== */
...
#define MDR_ADC_ADC1_Cfg_SYNC_CONV_Pos    (16UL)                    /*!< MDR_ADC ADC1_Cfg: SYNC_CONV (Bit 16)                  */
#define MDR_ADC_ADC1_Cfg_SYNC_CONV_Msk    (0x10000UL)               /*!< MDR_ADC ADC1_Cfg: SYNC_CONV (Bitfield-Mask: 0x01)     */
...
#define MDR_ADC_ADC1_Cfg_TR_Pos           (21UL)                    /*!< MDR_ADC ADC1_Cfg: TR (Bit 21)                         */
#define MDR_ADC_ADC1_Cfg_TR_Msk           (0x1e00000UL)             /*!< MDR_ADC ADC1_Cfg: TR (Bitfield-Mask: 0x0f)            */
...
#define MDR_ADC_ADC1_Cfg_Delay_ADC_Pos    (28UL)                    /*!< MDR_ADC ADC1_Cfg: Delay_ADC (Bit 28)                  */
#define MDR_ADC_ADC1_Cfg_Delay_ADC_Msk    (0xf0000000UL)            /*!< MDR_ADC ADC1_Cfg: Delay_ADC (Bitfield-Mask: 0x0f)     */
/* =======================================================  ADC2_Cfg  ======================================================== */
#define MDR_ADC_ADC2_Cfg_ADON_Pos         (0UL)                     /*!< MDR_ADC ADC2_Cfg: ADON (Bit 0)                        */
#define MDR_ADC_ADC2_Cfg_ADON_Msk         (0x1UL)                   /*!< MDR_ADC ADC2_Cfg: ADON (Bitfield-Mask: 0x01)          */
#define MDR_ADC_ADC2_Cfg_GO_Pos           (1UL)                     /*!< MDR_ADC ADC2_Cfg: GO (Bit 1)                          */
#define MDR_ADC_ADC2_Cfg_GO_Msk           (0x2UL)                   /*!< MDR_ADC ADC2_Cfg: GO (Bitfield-Mask: 0x01)            */
#define MDR_ADC_ADC2_Cfg_CLKS_Pos         (2UL)                     /*!< MDR_ADC ADC2_Cfg: CLKS (Bit 2)                        */
#define MDR_ADC_ADC2_Cfg_CLKS_Msk         (0x4UL)                   /*!< MDR_ADC ADC2_Cfg: CLKS (Bitfield-Mask: 0x01)          */
#define MDR_ADC_ADC2_Cfg_SAMPLE_Pos       (3UL)                     /*!< MDR_ADC ADC2_Cfg: SAMPLE (Bit 3)                      */
#define MDR_ADC_ADC2_Cfg_SAMPLE_Msk       (0x8UL)                   /*!< MDR_ADC ADC2_Cfg: SAMPLE (Bitfield-Mask: 0x01)        */
#define MDR_ADC_ADC2_Cfg_CHS_Pos          (4UL)                     /*!< MDR_ADC ADC2_Cfg: CHS (Bit 4)                         */
#define MDR_ADC_ADC2_Cfg_CHS_Msk          (0x1f0UL)                 /*!< MDR_ADC ADC2_Cfg: CHS (Bitfield-Mask: 0x1f)           */
#define MDR_ADC_ADC2_Cfg_CHCH_Pos         (9UL)                     /*!< MDR_ADC ADC2_Cfg: CHCH (Bit 9)                        */
#define MDR_ADC_ADC2_Cfg_CHCH_Msk         (0x200UL)                 /*!< MDR_ADC ADC2_Cfg: CHCH (Bitfield-Mask: 0x01)          */
#define MDR_ADC_ADC2_Cfg_RGNC_Pos         (10UL)                    /*!< MDR_ADC ADC2_Cfg: RGNC (Bit 10)                       */
#define MDR_ADC_ADC2_Cfg_RGNC_Msk         (0x400UL)                 /*!< MDR_ADC ADC2_Cfg: RGNC (Bitfield-Mask: 0x01)          */
#define MDR_ADC_ADC2_Cfg_M_REF_Pos        (11UL)                    /*!< MDR_ADC ADC2_Cfg: M_REF (Bit 11)                      */
#define MDR_ADC_ADC2_Cfg_M_REF_Msk        (0x800UL)                 /*!< MDR_ADC ADC2_Cfg: M_REF (Bitfield-Mask: 0x01)         */
#define MDR_ADC_ADC2_Cfg_DIV_CLK_Pos      (12UL)                    /*!< MDR_ADC ADC2_Cfg: DIV_CLK (Bit 12)                    */
#define MDR_ADC_ADC2_Cfg_DIV_CLK_Msk      (0xf000UL)                /*!< MDR_ADC ADC2_Cfg: DIV_CLK (Bitfield-Mask: 0x0f)       */
...
#define MDR_ADC_ADC2_Cfg_ADC2_OP_Pos      (18UL)                    /*!< MDR_ADC ADC2_Cfg: ADC2_OP (Bit 18)                    */
#define MDR_ADC_ADC2_Cfg_ADC2_OP_Msk      (0x40000UL)               /*!< MDR_ADC ADC2_Cfg: ADC2_OP (Bitfield-Mask: 0x01)       */
#define MDR_ADC_ADC2_Cfg_Delay_GO_Pos     (25UL)                    /*!< MDR_ADC ADC2_Cfg: Delay_GO (Bit 25)                   */
#define MDR_ADC_ADC2_Cfg_Delay_GO_Msk     (0xe000000UL)             /*!< MDR_ADC ADC2_Cfg: Delay_GO (Bitfield-Mask: 0x07)      */
/* =====================================================  ADC1_H_Level  ====================================================== */
...
/* =====================================================  ADC2_H_Level  ====================================================== */
#define MDR_ADC_ADC2_H_Level_Level_Pos    (0UL)                     /*!< MDR_ADC ADC2_H_Level: Level (Bit 0)                   */
#define MDR_ADC_ADC2_H_Level_Level_Msk    (0xfffUL)                 /*!< MDR_ADC ADC2_H_Level: Level (Bitfield-Mask: 0xfff)    */
/* =====================================================  ADC1_L_Level  ====================================================== */
...
/* =====================================================  ADC2_L_Level  ====================================================== */
#define MDR_ADC_ADC2_L_Level_Level_Pos    (0UL)                     /*!< MDR_ADC ADC2_L_Level: Level (Bit 0)                   */
#define MDR_ADC_ADC2_L_Level_Level_Msk    (0xfffUL)                 /*!< MDR_ADC ADC2_L_Level: Level (Bitfield-Mask: 0xfff)    */
/* ======================================================  ADC1_RESULT  ====================================================== */
...
/* ======================================================  ADC2_RESULT  ====================================================== */
#define MDR_ADC_ADC2_RESULT_Value_Pos     (0UL)                     /*!< MDR_ADC ADC2_RESULT: Value (Bit 0)                    */
#define MDR_ADC_ADC2_RESULT_Value_Msk     (0xfffUL)                 /*!< MDR_ADC ADC2_RESULT: Value (Bitfield-Mask: 0xfff)     */
#define MDR_ADC_ADC2_RESULT_Channel_Pos   (16UL)                    /*!< MDR_ADC ADC2_RESULT: Channel (Bit 16)                 */
#define MDR_ADC_ADC2_RESULT_Channel_Msk   (0x1f0000UL)              /*!< MDR_ADC ADC2_RESULT: Channel (Bitfield-Mask: 0x1f)    */
/* ======================================================  ADC1_STATUS  ====================================================== */
...
/* ======================================================  ADC2_STATUS  ====================================================== */
#define MDR_ADC_ADC2_STATUS_Overwrite_Pos (0UL)                     /*!< MDR_ADC ADC2_STATUS: Overwrite (Bit 0)                */
#define MDR_ADC_ADC2_STATUS_Overwrite_Msk (0x1UL)                   /*!< MDR_ADC ADC2_STATUS: Overwrite (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC2_STATUS_AWOIFEN_Pos   (1UL)                     /*!< MDR_ADC ADC2_STATUS: AWOIFEN (Bit 1)                  */
#define MDR_ADC_ADC2_STATUS_AWOIFEN_Msk   (0x2UL)                   /*!< MDR_ADC ADC2_STATUS: AWOIFEN (Bitfield-Mask: 0x01)    */
#define MDR_ADC_ADC2_STATUS_EOCIF_Pos     (2UL)                     /*!< MDR_ADC ADC2_STATUS: EOCIF (Bit 2)                    */
#define MDR_ADC_ADC2_STATUS_EOCIF_Msk     (0x4UL)                   /*!< MDR_ADC ADC2_STATUS: EOCIF (Bitfield-Mask: 0x01)      */
#define MDR_ADC_ADC2_STATUS_AWOIF_IE_Pos  (3UL)                     /*!< MDR_ADC ADC2_STATUS: AWOIF_IE (Bit 3)                 */
#define MDR_ADC_ADC2_STATUS_AWOIF_IE_Msk  (0x8UL)                   /*!< MDR_ADC ADC2_STATUS: AWOIF_IE (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_STATUS_EOCIF_EN_Pos  (4UL)                     /*!< MDR_ADC ADC2_STATUS: EOCIF_EN (Bit 4)                 */
#define MDR_ADC_ADC2_STATUS_EOCIF_EN_Msk  (0x10UL)                  /*!< MDR_ADC ADC2_STATUS: EOCIF_EN (Bitfield-Mask: 0x01)   */
/* ======================================================  ADC1_CHSEL  ======================================================= */
...
#define MDR_ADC_ADC1_CHSEL_Channel_8_Pos  (8UL)                     /*!< MDR_ADC ADC1_CHSEL: Channel_8 (Bit 8)                 */
#define MDR_ADC_ADC1_CHSEL_Channel_8_Msk  (0x100UL)                 /*!< MDR_ADC ADC1_CHSEL: Channel_8 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC1_CHSEL_Channel_9_Pos  (9UL)                     /*!< MDR_ADC ADC1_CHSEL: Channel_9 (Bit 9)                 */
#define MDR_ADC_ADC1_CHSEL_Channel_9_Msk  (0x200UL)                 /*!< MDR_ADC ADC1_CHSEL: Channel_9 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC1_CHSEL_Channel_10_Pos (10UL)                    /*!< MDR_ADC ADC1_CHSEL: Channel_10 (Bit 10)               */
#define MDR_ADC_ADC1_CHSEL_Channel_10_Msk (0x400UL)                 /*!< MDR_ADC ADC1_CHSEL: Channel_10 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC1_CHSEL_Channel_11_Pos (11UL)                    /*!< MDR_ADC ADC1_CHSEL: Channel_11 (Bit 11)               */
#define MDR_ADC_ADC1_CHSEL_Channel_11_Msk (0x800UL)                 /*!< MDR_ADC ADC1_CHSEL: Channel_11 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC1_CHSEL_Channel_12_Pos (12UL)                    /*!< MDR_ADC ADC1_CHSEL: Channel_12 (Bit 12)               */
#define MDR_ADC_ADC1_CHSEL_Channel_12_Msk (0x1000UL)                /*!< MDR_ADC ADC1_CHSEL: Channel_12 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC1_CHSEL_Channel_13_Pos (13UL)                    /*!< MDR_ADC ADC1_CHSEL: Channel_13 (Bit 13)               */
#define MDR_ADC_ADC1_CHSEL_Channel_13_Msk (0x2000UL)                /*!< MDR_ADC ADC1_CHSEL: Channel_13 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC1_CHSEL_Channel_14_Pos (14UL)                    /*!< MDR_ADC ADC1_CHSEL: Channel_14 (Bit 14)               */
#define MDR_ADC_ADC1_CHSEL_Channel_14_Msk (0x4000UL)                /*!< MDR_ADC ADC1_CHSEL: Channel_14 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC1_CHSEL_Channel_15_Pos (15UL)                    /*!< MDR_ADC ADC1_CHSEL: Channel_15 (Bit 15)               */
#define MDR_ADC_ADC1_CHSEL_Channel_15_Msk (0x8000UL)                /*!< MDR_ADC ADC1_CHSEL: Channel_15 (Bitfield-Mask: 0x01)  */
...
/* ======================================================  ADC2_CHSEL  ======================================================= */
#define MDR_ADC_ADC2_CHSEL_Channel_0_Pos  (0UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_0 (Bit 0)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_0_Msk  (0x1UL)                   /*!< MDR_ADC ADC2_CHSEL: Channel_0 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_1_Pos  (1UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_1 (Bit 1)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_1_Msk  (0x2UL)                   /*!< MDR_ADC ADC2_CHSEL: Channel_1 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_2_Pos  (2UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_2 (Bit 2)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_2_Msk  (0x4UL)                   /*!< MDR_ADC ADC2_CHSEL: Channel_2 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_3_Pos  (3UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_3 (Bit 3)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_3_Msk  (0x8UL)                   /*!< MDR_ADC ADC2_CHSEL: Channel_3 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_4_Pos  (4UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_4 (Bit 4)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_4_Msk  (0x10UL)                  /*!< MDR_ADC ADC2_CHSEL: Channel_4 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_5_Pos  (5UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_5 (Bit 5)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_5_Msk  (0x20UL)                  /*!< MDR_ADC ADC2_CHSEL: Channel_5 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_6_Pos  (6UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_6 (Bit 6)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_6_Msk  (0x40UL)                  /*!< MDR_ADC ADC2_CHSEL: Channel_6 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_7_Pos  (7UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_7 (Bit 7)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_7_Msk  (0x80UL)                  /*!< MDR_ADC ADC2_CHSEL: Channel_7 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_8_Pos  (8UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_8 (Bit 8)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_8_Msk  (0x100UL)                 /*!< MDR_ADC ADC2_CHSEL: Channel_8 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_9_Pos  (9UL)                     /*!< MDR_ADC ADC2_CHSEL: Channel_9 (Bit 9)                 */
#define MDR_ADC_ADC2_CHSEL_Channel_9_Msk  (0x200UL)                 /*!< MDR_ADC ADC2_CHSEL: Channel_9 (Bitfield-Mask: 0x01)   */
#define MDR_ADC_ADC2_CHSEL_Channel_10_Pos (10UL)                    /*!< MDR_ADC ADC2_CHSEL: Channel_10 (Bit 10)               */
#define MDR_ADC_ADC2_CHSEL_Channel_10_Msk (0x400UL)                 /*!< MDR_ADC ADC2_CHSEL: Channel_10 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC2_CHSEL_Channel_11_Pos (11UL)                    /*!< MDR_ADC ADC2_CHSEL: Channel_11 (Bit 11)               */
#define MDR_ADC_ADC2_CHSEL_Channel_11_Msk (0x800UL)                 /*!< MDR_ADC ADC2_CHSEL: Channel_11 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC2_CHSEL_Channel_12_Pos (12UL)                    /*!< MDR_ADC ADC2_CHSEL: Channel_12 (Bit 12)               */
#define MDR_ADC_ADC2_CHSEL_Channel_12_Msk (0x1000UL)                /*!< MDR_ADC ADC2_CHSEL: Channel_12 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC2_CHSEL_Channel_13_Pos (13UL)                    /*!< MDR_ADC ADC2_CHSEL: Channel_13 (Bit 13)               */
#define MDR_ADC_ADC2_CHSEL_Channel_13_Msk (0x2000UL)                /*!< MDR_ADC ADC2_CHSEL: Channel_13 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC2_CHSEL_Channel_14_Pos (14UL)                    /*!< MDR_ADC ADC2_CHSEL: Channel_14 (Bit 14)               */
#define MDR_ADC_ADC2_CHSEL_Channel_14_Msk (0x4000UL)                /*!< MDR_ADC ADC2_CHSEL: Channel_14 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC2_CHSEL_Channel_15_Pos (15UL)                    /*!< MDR_ADC ADC2_CHSEL: Channel_15 (Bit 15)               */
#define MDR_ADC_ADC2_CHSEL_Channel_15_Msk (0x8000UL)                /*!< MDR_ADC ADC2_CHSEL: Channel_15 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC2_CHSEL_Channel_30_Pos (30UL)                    /*!< MDR_ADC ADC2_CHSEL: Channel_30 (Bit 30)               */
#define MDR_ADC_ADC2_CHSEL_Channel_30_Msk (0x40000000UL)            /*!< MDR_ADC ADC2_CHSEL: Channel_30 (Bitfield-Mask: 0x01)  */
#define MDR_ADC_ADC2_CHSEL_Channel_31_Pos (31UL)                    /*!< MDR_ADC ADC2_CHSEL: Channel_31 (Bit 31)               */
#define MDR_ADC_ADC2_CHSEL_Channel_31_Msk (0x80000000UL)            /*!< MDR_ADC ADC2_CHSEL: Channel_31 (Bitfield-Mask: 0x01)  */
...
/* =====================================  MDR_RST_CLOCK CLOCK_STATUS PLL_DSP_RDY [3..3]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_CLOCK_STATUS_PLL_DSP_RDY                                    */
  MDR_RST__DSP__PLL_RDY__NotReady      = 0,     /*!< NotReady : PLL not ready                                                  */
  MDR_RST__DSP__PLL_RDY__Ready         = 1,     /*!< Ready : PLL ready                                                         */
} MDR_RST__DSP__PLL_RDY__Enum;
...
/* =====================================  MDR_RST_CLOCK PLL_CONTROL PLL_DSP_ON [16..16]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_ON                                      */
  MDR_RST__PLL__DSP_EN__Off            = 0,     /*!< Off : PLL Off                                                             */
  MDR_RST__PLL__DSP_EN__On             = 1,     /*!< On : PLL On                                                               */
} MDR_RST__PLL__DSP_EN__Enum;

/* ====================================  MDR_RST_CLOCK PLL_CONTROL PLL_DSP_PLD [17..17]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_PLD                                     */
  MDR_RST__PLL__DSP_PLD__RestartOff    = 0,     /*!< RestartOff : PLL restart inactive                                         */
  MDR_RST__PLL__DSP_PLD__DoRestart     = 1,     /*!< DoRestart : PLL Do Restart                                                */
} MDR_RST__PLL__DSP_PLD__Enum;

/* ====================================  MDR_RST_CLOCK PLL_CONTROL PLL_DSP_MUL [20..23]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL                                     */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x1 = 0, /*!< x1 : PLL mul x1                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x2 = 1, /*!< x2 : PLL mul x2                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x3 = 2, /*!< x3 : PLL mul x3                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x4 = 3, /*!< x4 : PLL mul x4                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x5 = 4, /*!< x5 : PLL mul x5                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x6 = 5, /*!< x6 : PLL mul x6                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x7 = 6, /*!< x7 : PLL mul x7                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x8 = 7, /*!< x8 : PLL mul x8                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x9 = 8, /*!< x9 : PLL mul x9                                                           */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x10 = 9,/*!< x10 : PLL mul x10                                                         */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x11 = 10,/*!< x11 : PLL mul x11                                                        */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x12 = 11,/*!< x12 : PLL mul x12                                                        */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x13 = 12,/*!< x13 : PLL mul x13                                                        */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x14 = 13,/*!< x14 : PLL mul x14                                                        */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x15 = 14,/*!< x15 : PLL mul x15                                                        */
  MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_x16 = 15,/*!< x16 : PLL mul x16                                                        */
} MDR_RST_CLOCK_PLL_CONTROL_PLL_DSP_MUL_Enum;
...
/* =======================================================  PER_CLOCK  ======================================================= */
/* ======================================  MDR_RST_CLOCK PER_CLOCK SSP3_CLK_EN [0..0]  ======================================= */
typedef enum {                                  /*!< MDR_RST_CLOCK_PER_CLOCK_SSP3_CLK_EN                                       */
  MDR_RST__PER__SSP3_CLOCK__Off        = 0,     /*!< Off : Clock Disabled                                                      */
  MDR_RST__PER__SSP3_CLOCK__On         = 1,     /*!< On : Clock Enabled                                                        */
} MDR_RST__PER__SSP3_CLOCK__Enum;

/* ======================================  MDR_RST_CLOCK PER_CLOCK SSP4_CLK_EN [1..1]  ======================================= */
typedef enum {                                  /*!< MDR_RST_CLOCK_PER_CLOCK_SSP4_CLK_EN                                       */
  MDR_RST_CLOCK_PER_CLOCK_SSP4_CLK_EN_Off = 0,  /*!< Off : Clock Disabled                                                      */
  MDR_RST_CLOCK_PER_CLOCK_SSP4_CLK_EN_On = 1,   /*!< On : Clock Enabled                                                        */
} MDR_RST_CLOCK_PER_CLOCK_SSP4_CLK_EN_Enum;
...
/* ======================================  MDR_RST_CLOCK PER_CLOCK SDIO_CLK_EN [9..9]  ======================================= */
typedef enum {                                  /*!< MDR_RST_CLOCK_PER_CLOCK_SDIO_CLK_EN                                       */
  MDR_RST_CLOCK_PER_CLOCK_SDIO_CLK_EN_Off = 0,  /*!< Off : Clock Disabled                                                      */
  MDR_RST_CLOCK_PER_CLOCK_SDIO_CLK_EN_On = 1,   /*!< On : Clock Enabled                                                        */
} MDR_RST_CLOCK_PER_CLOCK_SDIO_CLK_EN_Enum;

/* ======================================  MDR_RST_CLOCK PER_CLOCK I2C_CLK_EN [10..10]  ====================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_PER_CLOCK_I2C_CLK_EN                                        */
  MDR_RST_CLOCK_PER_CLOCK_I2C_CLK_EN_Off = 0,   /*!< Off : Clock Disabled                                                      */
  MDR_RST_CLOCK_PER_CLOCK_I2C_CLK_EN_On = 1,    /*!< On : Clock Enabled                                                        */
} MDR_RST_CLOCK_PER_CLOCK_I2C_CLK_EN_Enum;
...
/* ======================================  MDR_RST_CLOCK PER_CLOCK CMP_CLK_EN [19..19]  ====================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_PER_CLOCK_CMP_CLK_EN                                        */
  MDR_RST_CLOCK_PER_CLOCK_CMP_CLK_EN_Off = 0,   /*!< Off : Clock Disabled                                                      */
  MDR_RST_CLOCK_PER_CLOCK_CMP_CLK_EN_On = 1,    /*!< On : Clock Enabled                                                        */
} MDR_RST_CLOCK_PER_CLOCK_CMP_CLK_EN_Enum;
...
/* =====================================  MDR_RST_CLOCK PER_CLOCK UART3_CLK_EN [26..26]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_PER_CLOCK_UART3_CLK_EN                                      */
  MDR_RST_CLOCK_PER_CLOCK_UART3_CLK_EN_Off = 0, /*!< Off : Clock Disabled                                                      */
  MDR_RST_CLOCK_PER_CLOCK_UART3_CLK_EN_On = 1,  /*!< On : Clock Enabled                                                        */
} MDR_RST_CLOCK_PER_CLOCK_UART3_CLK_EN_Enum;
...
/* ======================================  MDR_RST_CLOCK PER_CLOCK AUC_CLK_EN [28..28]  ====================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_PER_CLOCK_AUC_CLK_EN                                        */
  MDR_RST_CLOCK_PER_CLOCK_AUC_CLK_EN_Off = 0,   /*!< Off : Clock Disabled                                                      */
  MDR_RST_CLOCK_PER_CLOCK_AUC_CLK_EN_On = 1,    /*!< On : Clock Enabled                                                        */
} MDR_RST_CLOCK_PER_CLOCK_AUC_CLK_EN_Enum;
...
/* ====================================  MDR_RST_CLOCK PER_CLOCK CRYPTO_CLK_EN [31..31]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_PER_CLOCK_CRYPTO_CLK_EN                                     */
  MDR_RST_CLOCK_PER_CLOCK_CRYPTO_CLK_EN_Off = 0,/*!< Off : Clock Disabled                                                      */
  MDR_RST_CLOCK_PER_CLOCK_CRYPTO_CLK_EN_On = 1, /*!< On : Clock Enabled                                                        */
} MDR_RST_CLOCK_PER_CLOCK_CRYPTO_CLK_EN_Enum;
...
/* ======================================  MDR_RST_CLOCK UART_CLOCK UART3_BRG [16..18]  ====================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_UART_CLOCK_UART3_BRG                                        */
  MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_div1 = 0,  /*!< div1 : div by 1                                                           */
  MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_div2 = 1,  /*!< div2 : div by 2                                                           */
  MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_div4 = 2,  /*!< div4 : div by 4                                                           */
  MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_div8 = 3,  /*!< div8 : div by 8                                                           */
  MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_div16 = 4, /*!< div16 : div by 16                                                         */
  MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_div32 = 5, /*!< div32 : div by 32                                                         */
  MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_div64 = 6, /*!< div64 : div by 64                                                         */
  MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_div128 = 7,/*!< div128 : div by 128                                                       */
} MDR_RST_CLOCK_UART_CLOCK_UART3_BRG_Enum;
...
/* ====================================  MDR_RST_CLOCK UART_CLOCK UART3_CLK_EN [26..26]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_UART_CLOCK_UART3_CLK_EN                                     */
  MDR_RST__UART__UART3_CLK__Off        = 0,     /*!< Off : UART3 Clock Disabled                                                */
  MDR_RST__UART__UART3_CLK__On         = 1,     /*!< On : UART3 Clock Enabled                                                  */
} MDR_RST__UART__UART3_CLK__Enum;
...
/* =======================================================  DSP_CLOCK  ======================================================= */
/* =======================================  MDR_RST_CLOCK DSP_CLOCK DSP_C1_SEL [0..1]  ======================================= */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CLOCK_DSP_C1_SEL                                        */
  MDR_RST__DSP__C1__HSI                = 0,     /*!< HSI : DSP_C1 output is HSI                                                */
  MDR_RST__DSP__C1__HSI/2              = 1,     /*!< HSI/2 : DSP_C1 output is HSI/2                                            */
  MDR_RST__DSP__C1__HSE                = 2,     /*!< HSE : DSP_C1 output is HSE                                                */
  MDR_RST__DSP__C1__HSE/2              = 3,     /*!< HSE/2 : DSP_C1 output is HSE/2                                            */
} MDR_RST__DSP__C1__Enum;

/* =======================================  MDR_RST_CLOCK DSP_CLOCK DSP_C2_SEL [2..2]  ======================================= */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CLOCK_DSP_C2_SEL                                        */
  MDR_RST__DSP__C2__DSP_C1             = 0,     /*!< DSP_C1 : Freq from DSP_C1 mux direct                                      */
  MDR_RST__DSP__C2__PLLDSPo            = 1,     /*!< PLLDSPo : Freq from CPU_C1 mux through PLL_DSP                            */
} MDR_RST__DSP__C2__Enum;

/* =======================================  MDR_RST_CLOCK DSP_CLOCK DSP_C3_SEL [4..4]  ======================================= */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CLOCK_DSP_C3_SEL                                        */
  MDR_RST__DSP__C3__DSP_C2             = 0,     /*!< DSP_C2 : C3 Input is freq from C2                                         */
  MDR_RST__DSP__C3__DSP_C2_div2        = 1,     /*!< DSP_C2_div2 : C3 Input is freq from C2/2                                  */
} MDR_RST__DSP__C3__Enum;

/* =========================================  MDR_RST_CLOCK DSP_CLOCK DSP_EN [8..8]  ========================================= */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CLOCK_DSP_EN                                            */
  MDR_RST__DSP__CLOCK__Off             = 0,     /*!< Off : Clock Disabled                                                      */
  MDR_RST__DSP__CLOCK__On              = 1,     /*!< On : Clock Enabled                                                        */
} MDR_RST__DSP__CLOCK__Enum;

/* ======================================================  SSP_CLOCK2  ======================================================= */
/* =======================================  MDR_RST_CLOCK SSP_CLOCK2 SSP4_BRG [0..2]  ======================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG                                         */
  MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_div1 = 0,   /*!< div1 : div by 1                                                           */
  MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_div2 = 1,   /*!< div2 : div by 2                                                           */
  MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_div4 = 2,   /*!< div4 : div by 4                                                           */
  MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_div8 = 3,   /*!< div8 : div by 8                                                           */
  MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_div16 = 4,  /*!< div16 : div by 16                                                         */
  MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_div32 = 5,  /*!< div32 : div by 32                                                         */
  MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_div64 = 6,  /*!< div64 : div by 64                                                         */
  MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_div128 = 7, /*!< div128 : div by 128                                                       */
} MDR_RST_CLOCK_SSP_CLOCK2_SSP4_BRG_Enum;

/* =====================================  MDR_RST_CLOCK SSP_CLOCK2 SSP4_CLK_EN [24..24]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_SSP_CLOCK2_SSP4_CLK_EN                                      */
  MDR_RST__SSP4__CLK__Off              = 0,     /*!< Off : SSP4 Clock Disabled                                                 */
  MDR_RST__SSP4__CLK__On               = 1,     /*!< On : SSP4 Clock Enabled                                                   */
} MDR_RST__SSP4__CLK__Enum;

/* ==================================================  DSP_CONTROL_STATUS  =================================================== */
/* ====================================  MDR_RST_CLOCK DSP_CONTROL_STATUS RST_DSP [0..0]  ==================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP                                  */
  MDR_RST__DSP__RST_BLOCK__Work        = 0,     /*!< Work : DSP Block is Active                                                */
  MDR_RST__DSP__RST_BLOCK__Reset       = 1,     /*!< Reset : DSP Block in Reset                                                */
} MDR_RST__DSP__RST_BLOCK__Enum;

/* ==================================  MDR_RST_CLOCK DSP_CONTROL_STATUS RST_DSP_CPU [1..1]  ================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_CPU                              */
  MDR_RST__DSP__RST_CPU__Work          = 0,     /*!< Work : DSP Core is Active                                                 */
  MDR_RST__DSP__RST_CPU__Reset         = 1,     /*!< Reset : DSP Core in Reset                                                 */
} MDR_RST__DSP__RST_CPU__Enum;

/* ==================================  MDR_RST_CLOCK DSP_CONTROL_STATUS RST_DSP_MEM [2..2]  ================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_MEM                              */
  MDR_RST__DSP__RST_MEM__Work          = 0,     /*!< Work : DSP memory is Active                                               */
  MDR_RST__DSP__RST_MEM__Reset         = 1,     /*!< Reset : DSP memory disabled                                               */
} MDR_RST__DSP__RST_MEM__Enum;

/* ==================================  MDR_RST_CLOCK DSP_CONTROL_STATUS RST_DSP_PER [3..3]  ================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_RST_DSP_PER                              */
  MDR_RST__DSP__RST_PER__Work          = 0,     /*!< Work : DSP Peripherials are Active                                        */
  MDR_RST__DSP__RST_PER__Reset         = 1,     /*!< Reset : DSP Peripherials in Reset                                         */
} MDR_RST__DSP__RST_PER__Enum;

/* =====================================  MDR_RST_CLOCK DSP_CONTROL_STATUS HOLD [4..4]  ====================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_HOLD                                     */
  MDR_RST__DSP__HOLD__DoStop           = 0,     /*!< DoStop : Request to Stop execution                                        */
  MDR_RST__DSP__HOLD__Inactive         = 1,     /*!< Inactive : Stop request inactive                                          */
} MDR_RST__DSP__HOLD__Enum;

/* ======================================  MDR_RST_CLOCK DSP_CONTROL_STATUS BIO [5..5]  ====================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_BIO                                      */
  MDR_RST__DSP__BIO__Low               = 0,     /*!< Low : Flag Low Level                                                      */
  MDR_RST__DSP__BIO__High              = 1,     /*!< High : Flag High Level                                                    */
} MDR_RST__DSP__BIO__Enum;

/* =====================================  MDR_RST_CLOCK DSP_CONTROL_STATUS XF_EN [6..6]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_XF_EN                                    */
  MDR_RST__DSP__XF_EN__Disable         = 0,     /*!< Disable : Flag XF disconnected from PA[15]                                */
  MDR_RST__DSP__XF_EN__Enable          = 1,     /*!< Enable : Flag XF connected to PA[15]                                      */
} MDR_RST__DSP__XF_EN__Enum;

/* ======================================  MDR_RST_CLOCK DSP_CONTROL_STATUS XF [8..8]  ======================================= */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_XF                                       */
  MDR_RST__DSP__XF__Low                = 0,     /*!< Low : Flag Low Level                                                      */
  MDR_RST__DSP__XF__High               = 1,     /*!< High : Flag High Level                                                    */
} MDR_RST__DSP__XF__Enum;

/* =====================================  MDR_RST_CLOCK DSP_CONTROL_STATUS HOLDA [9..9]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_HOLDA                                    */
  MDR_RST__DSP__HOLDA__Stopped         = 0,     /*!< Stopped : Command execution stopped                                       */
  MDR_RST__DSP__HOLDA__Running         = 1,     /*!< Running : Commands are executing                                          */
} MDR_RST__DSP__HOLDA__Enum;

/* ====================================  MDR_RST_CLOCK DSP_CONTROL_STATUS IDLE [10..11]  ===================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_IDLE                                     */
  MDR_RST__DSP__IDLE__Working          = 0,     /*!< Working : DSP Running                                                     */
  MDR_RST__DSP__IDLE__NO_CLOCK_DSP     = 1,     /*!< NO_CLOCK_DSP : DSP Clock disabled                                         */
  MDR_RST__DSP__IDLE__NO_CLOCK_DSP_MEM = 2,     /*!< NO_CLOCK_DSP_MEM : DSP Core and Memory Clock disabled                     */
  MDR_RST__DSP__IDLE__NO_CLOCK_DSP_MEM_PER = 3, /*!< NO_CLOCK_DSP_MEM_PER : DSP Core, Memory and Peripherials Clock
                                                                    disabled                                                   */
} MDR_RST__DSP__IDLE__Enum;

/* ====================================  MDR_RST_CLOCK DSP_CONTROL_STATUS BRTRD [14..14]  ==================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_BRTRD                                    */
  MDR_RST__DSP__BRIDGE__Transfer       = 0,     /*!< Transfer : Transfer is performing                                         */
  MDR_RST__DSP__BRIDGE__Completed      = 1,     /*!< Completed : Transfer completed                                            */
} MDR_RST__DSP__BRIDGE__Enum;

/* =================================  MDR_RST_CLOCK DSP_CONTROL_STATUS RD_BUFF_EN [15..15]  ================================== */
typedef enum {                                  /*!< MDR_RST_CLOCK_DSP_CONTROL_STATUS_RD_BUFF_EN                               */
  MDR_RST__DSP__PreRead__Off           = 0,     /*!< Off : Pre-Read disabled                                                   */
  MDR_RST__DSP__PreRead__On            = 1,     /*!< On : Pre-Read enabled                                                     */
} MDR_RST__DSP__PreRead__Enum;
...
/* ==========================================================  PRH  ========================================================== */
/* ==========================================================  CTR  ========================================================== */
/* ===============================================  MDR_I2C CTR S_I2C [5..5]  ================================================ */
typedef enum {                                  /*!< MDR_I2C_CTR_S_I2C                                                         */
  MDR_I2C_CTR_S_I2C_less_400KHz        = 0,     /*!< less_400KHz : BitRate is less 400KHz                                      */
  MDR_I2C_CTR_S_I2C_less_1MHz          = 1,     /*!< less_1MHz : BitRate is less 1MHz                                          */
} MDR_I2C_CTR_S_I2C_Enum;

/* ===============================================  MDR_I2C CTR EN_INT [6..6]  =============================================== */
typedef enum {                                  /*!< MDR_I2C_CTR_EN_INT                                                        */
  MDR_I2C_CTR_EN_INT_Off               = 0,     /*!< Off : Disabled                                                            */
  MDR_I2C_CTR_EN_INT_On                = 1,     /*!< On : Enabled                                                              */
} MDR_I2C_CTR_EN_INT_Enum;

/* ===============================================  MDR_I2C CTR EN_I2C [7..7]  =============================================== */
typedef enum {                                  /*!< MDR_I2C_CTR_EN_I2C                                                        */
  MDR_I2C_CTR_EN_I2C_Off               = 0,     /*!< Off : Disabled                                                            */
  MDR_I2C_CTR_EN_I2C_On                = 1,     /*!< On : Enabled                                                              */
} MDR_I2C_CTR_EN_I2C_Enum;

/* ==========================================================  RXD  ========================================================== */
/* ==========================================================  STA  ========================================================== */
/* ================================================  MDR_I2C STA INT [0..0]  ================================================= */
typedef enum {                                  /*!< MDR_I2C_STA_INT                                                           */
  MDR_I2C_STA_INT_Off                  = 0,     /*!< Off : Inactive                                                            */
  MDR_I2C_STA_INT_On                   = 1,     /*!< On : Active                                                               */
} MDR_I2C_STA_INT_Enum;

/* ==============================================  MDR_I2C STA TR_Prog [1..1]  =============================================== */
typedef enum {                                  /*!< MDR_I2C_STA_TR_Prog                                                       */
  MDR_I2C_STA_TR_Prog_Completed        = 0,     /*!< Completed : Transfering is completed                                      */
  MDR_I2C_STA_TR_Prog_Transfering      = 1,     /*!< Transfering : Transfering is not completed                                */
} MDR_I2C_STA_TR_Prog_Enum;

/* ==============================================  MDR_I2C STA Lost_ARB [5..5]  ============================================== */
typedef enum {                                  /*!< MDR_I2C_STA_Lost_ARB                                                      */
  MDR_I2C_STA_Lost_ARB_Ok              = 0,     /*!< Ok : Normal operation                                                     */
  MDR_I2C_STA_Lost_ARB_Collision       = 1,     /*!< Collision : Collision detected                                            */
} MDR_I2C_STA_Lost_ARB_Enum;

/* ================================================  MDR_I2C STA BUSY [6..6]  ================================================ */
typedef enum {                                  /*!< MDR_I2C_STA_BUSY                                                          */
  MDR_I2C_STA_BUSY_Bus_Free            = 0,     /*!< Bus_Free : Stop received                                                  */
  MDR_I2C_STA_BUSY_Bus_Busy            = 1,     /*!< Bus_Busy : Start received                                                 */
} MDR_I2C_STA_BUSY_Enum;

/* ===============================================  MDR_I2C STA RX_ACK [7..7]  =============================================== */
typedef enum {                                  /*!< MDR_I2C_STA_RX_ACK                                                        */
  MDR_I2C_STA_RX_ACK_Ok                = 0,     /*!< Ok : Acknowledge received                                                 */
  MDR_I2C_STA_RX_ACK_NoAck             = 1,     /*!< NoAck : No Acknowledge received                                           */
} MDR_I2C_STA_RX_ACK_Enum;

/* ==========================================================  TXD  ========================================================== */
/* ==========================================================  CMD  ========================================================== */
/* ==============================================  MDR_I2C CMD CLR_INT [0..0]  =============================================== */
typedef enum {                                  /*!< MDR_I2C_CMD_CLR_INT                                                       */
  MDR_I2C_CMD_CLR_INT_Inactive         = 0,     /*!< Inactive : Inactive state                                                 */
  MDR_I2C_CMD_CLR_INT_Clear            = 1,     /*!< Clear : Clear IRQ flag                                                    */
} MDR_I2C_CMD_CLR_INT_Enum;

/* ==============================================  MDR_I2C CMD Send_ACK [3..3]  ============================================== */
typedef enum {                                  /*!< MDR_I2C_CMD_Send_ACK                                                      */
  MDR_I2C_CMD_Send_ACK_Inactive        = 0,     /*!< Inactive : Inactive state                                                 */
  MDR_I2C_CMD_Send_ACK_Send_Ack        = 1,     /*!< Send_Ack : Send Ack command                                               */
} MDR_I2C_CMD_Send_ACK_Enum;

/* ============================================  MDR_I2C CMD Start_Write [4..4]  ============================================= */
typedef enum {                                  /*!< MDR_I2C_CMD_Start_Write                                                   */
  MDR_I2C_CMD_Start_Write_Inactive     = 0,     /*!< Inactive : Inactive state                                                 */
  MDR_I2C_CMD_Start_Write_Start_Write  = 1,     /*!< Start_Write : Start writing                                               */
} MDR_I2C_CMD_Start_Write_Enum;

/* =============================================  MDR_I2C CMD Start_Read [5..5]  ============================================= */
typedef enum {                                  /*!< MDR_I2C_CMD_Start_Read                                                    */
  MDR_I2C_CMD_Start_Read_Inactive      = 0,     /*!< Inactive : Inactive state                                                 */
  MDR_I2C_CMD_Start_Read_Start_Read    = 1,     /*!< Start_Read : Start reading                                                */
} MDR_I2C_CMD_Start_Read_Enum;

/* =============================================  MDR_I2C CMD Send_Stop [6..6]  ============================================== */
typedef enum {                                  /*!< MDR_I2C_CMD_Send_Stop                                                     */
  MDR_I2C_CMD_Send_Stop_Inactive       = 0,     /*!< Inactive : Inactive state                                                 */
  MDR_I2C_CMD_Send_Stop_Send_Stop      = 1,     /*!< Send_Stop : Send Stop command                                             */
} MDR_I2C_CMD_Send_Stop_Enum;

/* =============================================  MDR_I2C CMD Send_Start [7..7]  ============================================= */
typedef enum {                                  /*!< MDR_I2C_CMD_Send_Start                                                    */
  MDR_I2C_CMD_Send_Start_Inactive      = 0,     /*!< Inactive : Inactive state                                                 */
  MDR_I2C_CMD_Send_Start_Send_Start    = 1,     /*!< Send_Start : Send Start command                                           */
} MDR_I2C_CMD_Send_Start_Enum;
...
typedef enum {                                  /*!< MDR_ADC_ADC1_Cfg_CHS                                                      */
  MDR_ADC_ADC1_Cfg_CHS_Channel_0_RefP  = 0,     /*!< Channel_0_RefP : Signal on PD0, Ref+                                      */
  MDR_ADC_ADC1_Cfg_CHS_Channel_1_RefN  = 1,     /*!< Channel_1_RefN : Signal on PD1, Ref-                                      */
  MDR_ADC_ADC1_Cfg_CHS_Channel_2       = 2,     /*!< Channel_2 : Signal on PD2                                                 */
  MDR_ADC_ADC1_Cfg_CHS_Channel_3       = 3,     /*!< Channel_3 : Signal on PD3                                                 */
  MDR_ADC_ADC1_Cfg_CHS_Channel_4       = 4,     /*!< Channel_4 : Signal on PD4                                                 */
  MDR_ADC_ADC1_Cfg_CHS_Channel_5       = 5,     /*!< Channel_5 : Signal on PD5                                                 */
  MDR_ADC_ADC1_Cfg_CHS_Channel_6       = 6,     /*!< Channel_6 : Signal on PD6                                                 */
  MDR_ADC_ADC1_Cfg_CHS_Channel_7       = 7,     /*!< Channel_7 : Signal on PD7                                                 */
  MDR_ADC_ADC1_Cfg_CHS_Channel_8       = 8,     /*!< Channel_8 : Signal on PD8                                                 */
  MDR_ADC_ADC1_Cfg_CHS_Channel_9       = 9,     /*!< Channel_9 : Signal on PD9                                                 */
  MDR_ADC_ADC1_Cfg_CHS_Channel_10      = 10,    /*!< Channel_10 : Signal on PD10                                               */
  MDR_ADC_ADC1_Cfg_CHS_Channel_11      = 11,    /*!< Channel_11 : Signal on PD11                                               */
  MDR_ADC_ADC1_Cfg_CHS_Channel_12      = 12,    /*!< Channel_12 : Signal on PD12                                               */
  MDR_ADC_ADC1_Cfg_CHS_Channel_13      = 13,    /*!< Channel_13 : Signal on PD13                                               */
  MDR_ADC_ADC1_Cfg_CHS_Channel_14      = 14,    /*!< Channel_14 : Signal on PD14                                               */
  MDR_ADC_ADC1_Cfg_CHS_Channel_15      = 15,    /*!< Channel_15 : Signal on PD15                                               */
...
/* ==========================================  MDR_ADC ADC1_Cfg SYNC_CONV [16..16]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC1_Cfg_SYNC_CONV                                                */
  MDR_ADC_ADC1_Cfg_SYNC_CONV_NoSync    = 0,     /*!< NoSync : No sync ADC1 and ADC2                                            */
  MDR_ADC_ADC1_Cfg_SYNC_CONV_Sync      = 1,     /*!< Sync : ADC1 and ADC2 sync enable                                          */
} MDR_ADC_ADC1_Cfg_SYNC_CONV_Enum;
...
/* =============================================  MDR_ADC ADC1_Cfg TR [21..24]  ============================================== */
typedef enum {                                  /*!< MDR_ADC_ADC1_Cfg_TR                                                       */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v23        = 0,     /*!< Vref_1v23 : 1.23V typically                                               */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v213       = 1,     /*!< Vref_1v213 : 1.213V typically                                             */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v211       = 2,     /*!< Vref_1v211 : 1.211V typically                                             */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v208       = 3,     /*!< Vref_1v208 : 1.208V typically                                             */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v206       = 4,     /*!< Vref_1v206 : 1.206V typically                                             */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v203       = 5,     /*!< Vref_1v203 : 1.203V typically                                             */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v200       = 6,     /*!< Vref_1v200 : 1.200V typically                                             */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v197       = 7,     /*!< Vref_1v197 : 1.197V typically                                             */
  MDR_ADC_ADC1_Cfg_TR_Vref_1v193       = 8,     /*!< Vref_1v193 : 1.193V typically                                             */
} MDR_ADC_ADC1_Cfg_TR_Enum;
...
/* ==========================================  MDR_ADC ADC1_Cfg Delay_ADC [28..31]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC1_Cfg_Delay_ADC                                                */
  MDR_ADC_ADC1_Cfg_Delay_ADC_1         = 0,     /*!< 1 : 1 period of CPU_CLK                                                   */
  MDR_ADC_ADC1_Cfg_Delay_ADC_2         = 1,     /*!< 2 : 2 periods of CPU_CLK                                                  */
  MDR_ADC_ADC1_Cfg_Delay_ADC_3         = 2,     /*!< 3 : 3 periods of CPU_CLK                                                  */
  MDR_ADC_ADC1_Cfg_Delay_ADC_4         = 3,     /*!< 4 : 4 periods of CPU_CLK                                                  */
  MDR_ADC_ADC1_Cfg_Delay_ADC_5         = 4,     /*!< 5 : 5 periods of CPU_CLK                                                  */
  MDR_ADC_ADC1_Cfg_Delay_ADC_6         = 5,     /*!< 6 : 6 periods of CPU_CLK                                                  */
  MDR_ADC_ADC1_Cfg_Delay_ADC_7         = 6,     /*!< 7 : 7 periods of CPU_CLK                                                  */
  MDR_ADC_ADC1_Cfg_Delay_ADC_8         = 7,     /*!< 8 : 8 periods of CPU_CLK                                                  */
  MDR_ADC_ADC1_Cfg_Delay_ADC_9         = 8,     /*!< 9 : 9 period of CPU_CLK                                                   */
  MDR_ADC_ADC1_Cfg_Delay_ADC_10        = 9,     /*!< 10 : 10 periods of CPU_CLK                                                */
  MDR_ADC_ADC1_Cfg_Delay_ADC_11        = 10,    /*!< 11 : 11 periods of CPU_CLK                                                */
  MDR_ADC_ADC1_Cfg_Delay_ADC_12        = 11,    /*!< 12 : 12 periods of CPU_CLK                                                */
  MDR_ADC_ADC1_Cfg_Delay_ADC_13        = 12,    /*!< 13 : 13 periods of CPU_CLK                                                */
  MDR_ADC_ADC1_Cfg_Delay_ADC_14        = 13,    /*!< 14 : 14 periods of CPU_CLK                                                */
  MDR_ADC_ADC1_Cfg_Delay_ADC_15        = 14,    /*!< 15 : 15 periods of CPU_CLK                                                */
  MDR_ADC_ADC1_Cfg_Delay_ADC_16        = 15,    /*!< 16 : 16 periods of CPU_CLK                                                */
} MDR_ADC_ADC1_Cfg_Delay_ADC_Enum;

/* =======================================================  ADC2_Cfg  ======================================================== */
/* =============================================  MDR_ADC ADC2_Cfg ADON [0..0]  ============================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_ADON                                                     */
  MDR_ADC_ADC2_Cfg_ADON_Off            = 0,     /*!< Off : Disabled                                                            */
  MDR_ADC_ADC2_Cfg_ADON_On             = 1,     /*!< On : Enabled                                                              */
} MDR_ADC_ADC2_Cfg_ADON_Enum;

/* ==============================================  MDR_ADC ADC2_Cfg GO [1..1]  =============================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_GO                                                       */
  MDR_ADC_ADC2_Cfg_GO_Inactive         = 0,     /*!< Inactive : Autoclear to zero after start                                  */
  MDR_ADC_ADC2_Cfg_GO_Start            = 1,     /*!< Start : Start measurement                                                 */
} MDR_ADC_ADC2_Cfg_GO_Enum;

/* =============================================  MDR_ADC ADC2_Cfg CLKS [2..2]  ============================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_CLKS                                                     */
  MDR_ADC_ADC2_Cfg_CLKS_CPU_Clock      = 0,     /*!< CPU_Clock : CPU_Clock used                                                */
  MDR_ADC_ADC2_Cfg_CLKS_ADC_Clock      = 1,     /*!< ADC_Clock : ADC_Clock used                                                */
} MDR_ADC_ADC2_Cfg_CLKS_Enum;

/* ============================================  MDR_ADC ADC2_Cfg SAMPLE [3..3]  ============================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_SAMPLE                                                   */
  MDR_ADC_ADC2_Cfg_SAMPLE_Single       = 0,     /*!< Single : Single measurement by GO                                         */
  MDR_ADC_ADC2_Cfg_SAMPLE_Continuouse  = 1,     /*!< Continuouse : Continuous measurement, until stop by ADON                  */
} MDR_ADC_ADC2_Cfg_SAMPLE_Enum;

/* ==============================================  MDR_ADC ADC2_Cfg CHS [4..8]  ============================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_CHS                                                      */
  MDR_ADC_ADC2_Cfg_CHS_Channel_0_RefP  = 0,     /*!< Channel_0_RefP : Signal on PD0, Ref+                                      */
  MDR_ADC_ADC2_Cfg_CHS_Channel_1_RefN  = 1,     /*!< Channel_1_RefN : Signal on PD1, Ref-                                      */
  MDR_ADC_ADC2_Cfg_CHS_Channel_2       = 2,     /*!< Channel_2 : Signal on PD2                                                 */
  MDR_ADC_ADC2_Cfg_CHS_Channel_3       = 3,     /*!< Channel_3 : Signal on PD3                                                 */
  MDR_ADC_ADC2_Cfg_CHS_Channel_4       = 4,     /*!< Channel_4 : Signal on PD4                                                 */
  MDR_ADC_ADC2_Cfg_CHS_Channel_5       = 5,     /*!< Channel_5 : Signal on PD5                                                 */
  MDR_ADC_ADC2_Cfg_CHS_Channel_6       = 6,     /*!< Channel_6 : Signal on PD6                                                 */
  MDR_ADC_ADC2_Cfg_CHS_Channel_7       = 7,     /*!< Channel_7 : Signal on PD7                                                 */
  MDR_ADC_ADC2_Cfg_CHS_Channel_8       = 8,     /*!< Channel_8 : Signal on PD8                                                 */
  MDR_ADC_ADC2_Cfg_CHS_Channel_9       = 9,     /*!< Channel_9 : Signal on PD9                                                 */
  MDR_ADC_ADC2_Cfg_CHS_Channel_10      = 10,    /*!< Channel_10 : Signal on PD10                                               */
  MDR_ADC_ADC2_Cfg_CHS_Channel_11      = 11,    /*!< Channel_11 : Signal on PD11                                               */
  MDR_ADC_ADC2_Cfg_CHS_Channel_12      = 12,    /*!< Channel_12 : Signal on PD12                                               */
  MDR_ADC_ADC2_Cfg_CHS_Channel_13      = 13,    /*!< Channel_13 : Signal on PD13                                               */
  MDR_ADC_ADC2_Cfg_CHS_Channel_14      = 14,    /*!< Channel_14 : Signal on PD14                                               */
  MDR_ADC_ADC2_Cfg_CHS_Channel_15      = 15,    /*!< Channel_15 : Signal on PD15                                               */
  MDR_ADC_ADC2_Cfg_CHS_TS_VRef_1.23    = 30,    /*!< TS_VRef_1.23 : Signal from Thermosensor                                   */
  MDR_ADC_ADC2_Cfg_CHS_TS_Temperature  = 31,    /*!< TS_Temperature : Signal from Thermosensor                                 */
} MDR_ADC_ADC2_Cfg_CHS_Enum;

/* =============================================  MDR_ADC ADC2_Cfg CHCH [9..9]  ============================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_CHCH                                                     */
  MDR_ADC_ADC2_Cfg_CHCH_Disable        = 0,     /*!< Disable : Measure only CHS channel                                        */
  MDR_ADC_ADC2_Cfg_CHCH_Enable         = 1,     /*!< Enable : Measure channels selected in reg CHSEL                           */
} MDR_ADC_ADC2_Cfg_CHCH_Enum;

/* ============================================  MDR_ADC ADC2_Cfg RGNC [10..10]  ============================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_RGNC                                                     */
  MDR_ADC_ADC2_Cfg_RGNC_Disable        = 0,     /*!< Disable : Flag STATUSx.AWOIFEN inactive                                   */
  MDR_ADC_ADC2_Cfg_RGNC_Enable         = 1,     /*!< Enable : Flag STATUSx.AWOIFEN enable                                      */
} MDR_ADC_ADC2_Cfg_RGNC_Enum;

/* ============================================  MDR_ADC ADC2_Cfg M_REF [11..11]  ============================================ */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_M_REF                                                    */
  MDR_ADC_ADC2_Cfg_M_REF_Internal      = 0,     /*!< Internal : Signal in [GND..AUcc]                                          */
  MDR_ADC_ADC2_Cfg_M_REF_External      = 1,     /*!< External : Signal in [ADC_Ref-..ADC_Ref+]                                 */
} MDR_ADC_ADC2_Cfg_M_REF_Enum;

/* ===========================================  MDR_ADC ADC2_Cfg DIV_CLK [12..15]  =========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_DIV_CLK                                                  */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_1       = 0,     /*!< div_1 : CLK = CPU_CLK                                                     */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_2       = 1,     /*!< div_2 : CLK = CPU_CLK/2                                                   */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_4       = 2,     /*!< div_4 : CLK = CPU_CLK/4                                                   */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_8       = 3,     /*!< div_8 : CLK = CPU_CLK/8                                                   */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_16      = 4,     /*!< div_16 : CLK = CPU_CLK/16                                                 */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_32      = 5,     /*!< div_32 : CLK = CPU_CLK/32                                                 */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_64      = 6,     /*!< div_64 : CLK = CPU_CLK/64                                                 */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_128     = 7,     /*!< div_128 : CLK = CPU_CLK/128                                               */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_256     = 8,     /*!< div_256 : CLK = CPU_CLK/256                                               */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_512     = 9,     /*!< div_512 : CLK = CPU_CLK/512                                               */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_1024    = 10,    /*!< div_1024 : CLK = CPU_CLK/1024                                             */
  MDR_ADC_ADC2_Cfg_DIV_CLK_div_2048    = 11,    /*!< div_2048 : CLK = CPU_CLK/2048                                             */
} MDR_ADC_ADC2_Cfg_DIV_CLK_Enum;
...
/* ===========================================  MDR_ADC ADC2_Cfg ADC2_OP [18..18]  =========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_ADC2_OP                                                  */
  MDR_ADC_ADC2_Cfg_ADC2_OP_Own         = 0,     /*!< Own : Own setpoint Vref                                                   */
  MDR_ADC_ADC2_Cfg_ADC2_OP_Thermosensor = 1,    /*!< Thermosensor : Setpoint Vref from Thermosensor                            */
} MDR_ADC_ADC2_Cfg_ADC2_OP_Enum;

/* ==========================================  MDR_ADC ADC2_Cfg Delay_GO [25..27]  =========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_Cfg_Delay_GO                                                 */
  MDR_ADC_ADC2_Cfg_Delay_GO_1          = 0,     /*!< 1 : 1 period of CPU_CLK                                                   */
  MDR_ADC_ADC2_Cfg_Delay_GO_2          = 1,     /*!< 2 : 2 periods of CPU_CLK                                                  */
  MDR_ADC_ADC2_Cfg_Delay_GO_3          = 2,     /*!< 3 : 3 periods of CPU_CLK                                                  */
  MDR_ADC_ADC2_Cfg_Delay_GO_4          = 3,     /*!< 4 : 4 periods of CPU_CLK                                                  */
  MDR_ADC_ADC2_Cfg_Delay_GO_5          = 4,     /*!< 5 : 5 periods of CPU_CLK                                                  */
  MDR_ADC_ADC2_Cfg_Delay_GO_6          = 5,     /*!< 6 : 6 periods of CPU_CLK                                                  */
  MDR_ADC_ADC2_Cfg_Delay_GO_7          = 6,     /*!< 7 : 7 periods of CPU_CLK                                                  */
  MDR_ADC_ADC2_Cfg_Delay_GO_8          = 7,     /*!< 8 : 8 periods of CPU_CLK                                                  */
} MDR_ADC_ADC2_Cfg_Delay_GO_Enum;
...
typedef enum {                                  /*!< MDR_ADC_ADC1_RESULT_Channel                                               */
  MDR_ADC_ADC1_RESULT_Channel_Channel_0_RefP = 0,/*!< Channel_0_RefP : Signal on PD0, Ref+                                     */
  MDR_ADC_ADC1_RESULT_Channel_Channel_1_RefN = 1,/*!< Channel_1_RefN : Signal on PD1, Ref-                                     */
  MDR_ADC_ADC1_RESULT_Channel_Channel_2 = 2,    /*!< Channel_2 : Signal on PD2                                                 */
  MDR_ADC_ADC1_RESULT_Channel_Channel_3 = 3,    /*!< Channel_3 : Signal on PD3                                                 */
  MDR_ADC_ADC1_RESULT_Channel_Channel_4 = 4,    /*!< Channel_4 : Signal on PD4                                                 */
  MDR_ADC_ADC1_RESULT_Channel_Channel_5 = 5,    /*!< Channel_5 : Signal on PD5                                                 */
  MDR_ADC_ADC1_RESULT_Channel_Channel_6 = 6,    /*!< Channel_6 : Signal on PD6                                                 */
  MDR_ADC_ADC1_RESULT_Channel_Channel_7 = 7,    /*!< Channel_7 : Signal on PD7                                                 */
  MDR_ADC_ADC1_RESULT_Channel_Channel_8 = 8,    /*!< Channel_8 : Signal on PD8                                                 */
  MDR_ADC_ADC1_RESULT_Channel_Channel_9 = 9,    /*!< Channel_9 : Signal on PD9                                                 */
  MDR_ADC_ADC1_RESULT_Channel_Channel_10 = 10,  /*!< Channel_10 : Signal on PD10                                               */
  MDR_ADC_ADC1_RESULT_Channel_Channel_11 = 11,  /*!< Channel_11 : Signal on PD11                                               */
  MDR_ADC_ADC1_RESULT_Channel_Channel_12 = 12,  /*!< Channel_12 : Signal on PD12                                               */
  MDR_ADC_ADC1_RESULT_Channel_Channel_13 = 13,  /*!< Channel_13 : Signal on PD13                                               */
  MDR_ADC_ADC1_RESULT_Channel_Channel_14 = 14,  /*!< Channel_14 : Signal on PD14                                               */
  MDR_ADC_ADC1_RESULT_Channel_Channel_15 = 15,  /*!< Channel_15 : Signal on PD15                                               */
...
/* ======================================================  ADC2_RESULT  ====================================================== */
/* =========================================  MDR_ADC ADC2_RESULT Channel [16..20]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_RESULT_Channel                                               */
  MDR_ADC_ADC2_RESULT_Channel_Channel_0_RefP = 0,/*!< Channel_0_RefP : Signal on PD0, Ref+                                     */
  MDR_ADC_ADC2_RESULT_Channel_Channel_1_RefN = 1,/*!< Channel_1_RefN : Signal on PD1, Ref-                                     */
  MDR_ADC_ADC2_RESULT_Channel_Channel_2 = 2,    /*!< Channel_2 : Signal on PD2                                                 */
  MDR_ADC_ADC2_RESULT_Channel_Channel_3 = 3,    /*!< Channel_3 : Signal on PD3                                                 */
  MDR_ADC_ADC2_RESULT_Channel_Channel_4 = 4,    /*!< Channel_4 : Signal on PD4                                                 */
  MDR_ADC_ADC2_RESULT_Channel_Channel_5 = 5,    /*!< Channel_5 : Signal on PD5                                                 */
  MDR_ADC_ADC2_RESULT_Channel_Channel_6 = 6,    /*!< Channel_6 : Signal on PD6                                                 */
  MDR_ADC_ADC2_RESULT_Channel_Channel_7 = 7,    /*!< Channel_7 : Signal on PD7                                                 */
  MDR_ADC_ADC2_RESULT_Channel_Channel_8 = 8,    /*!< Channel_8 : Signal on PD8                                                 */
  MDR_ADC_ADC2_RESULT_Channel_Channel_9 = 9,    /*!< Channel_9 : Signal on PD9                                                 */
  MDR_ADC_ADC2_RESULT_Channel_Channel_10 = 10,  /*!< Channel_10 : Signal on PD10                                               */
  MDR_ADC_ADC2_RESULT_Channel_Channel_11 = 11,  /*!< Channel_11 : Signal on PD11                                               */
  MDR_ADC_ADC2_RESULT_Channel_Channel_12 = 12,  /*!< Channel_12 : Signal on PD12                                               */
  MDR_ADC_ADC2_RESULT_Channel_Channel_13 = 13,  /*!< Channel_13 : Signal on PD13                                               */
  MDR_ADC_ADC2_RESULT_Channel_Channel_14 = 14,  /*!< Channel_14 : Signal on PD14                                               */
  MDR_ADC_ADC2_RESULT_Channel_Channel_15 = 15,  /*!< Channel_15 : Signal on PD15                                               */
  MDR_ADC_ADC2_RESULT_Channel_TS_VRef_1.23 = 30,/*!< TS_VRef_1.23 : Signal from Thermosensor                                   */
  MDR_ADC_ADC2_RESULT_Channel_TS_Temperature = 31,/*!< TS_Temperature : Signal from Thermosensor                               */
} MDR_ADC_ADC2_RESULT_Channel_Enum;
...
/* ======================================================  ADC2_STATUS  ====================================================== */
/* =========================================  MDR_ADC ADC2_STATUS Overwrite [0..0]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_STATUS_Overwrite                                             */
  MDR_ADC_ADC2_STATUS_Overwrite_Normal = 0,     /*!< Normal : No overwritten occure                                            */
  MDR_ADC_ADC2_STATUS_Overwrite_Overwrite = 1,  /*!< Overwrite : Result overwritten                                            */
} MDR_ADC_ADC2_STATUS_Overwrite_Enum;

/* ==========================================  MDR_ADC ADC2_STATUS AWOIFEN [1..1]  =========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_STATUS_AWOIFEN                                               */
  MDR_ADC_ADC2_STATUS_AWOIFEN_InRange  = 0,     /*!< InRange : Signal in range                                                 */
  MDR_ADC_ADC2_STATUS_AWOIFEN_OutOfRange = 1,   /*!< OutOfRange : Signal is out of range                                       */
} MDR_ADC_ADC2_STATUS_AWOIFEN_Enum;

/* ===========================================  MDR_ADC ADC2_STATUS EOCIF [2..2]  ============================================ */
typedef enum {                                  /*!< MDR_ADC_ADC2_STATUS_EOCIF                                                 */
  MDR_ADC_ADC2_STATUS_EOCIF_NoResult   = 0,     /*!< NoResult : Result is not ready                                            */
  MDR_ADC_ADC2_STATUS_EOCIF_Ready      = 1,     /*!< Ready : Signal is ready to read                                           */
} MDR_ADC_ADC2_STATUS_EOCIF_Enum;

/* ==========================================  MDR_ADC ADC2_STATUS AWOIF_IE [3..3]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_STATUS_AWOIF_IE                                              */
  MDR_ADC_ADC2_STATUS_AWOIF_IE_Disable = 0,     /*!< Disable : IRQ Disable                                                     */
  MDR_ADC_ADC2_STATUS_AWOIF_IE_Enable  = 1,     /*!< Enable : IRQ Enable                                                       */
} MDR_ADC_ADC2_STATUS_AWOIF_IE_Enum;

/* ==========================================  MDR_ADC ADC2_STATUS EOCIF_EN [4..4]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_STATUS_EOCIF_EN                                              */
  MDR_ADC_ADC2_STATUS_EOCIF_EN_Disable = 0,     /*!< Disable : IRQ Disable                                                     */
  MDR_ADC_ADC2_STATUS_EOCIF_EN_Enable  = 1,     /*!< Enable : IRQ Enable                                                       */
} MDR_ADC_ADC2_STATUS_EOCIF_EN_Enum;
...
/* ==========================================  MDR_ADC ADC1_CHSEL Channel_8 [8..8]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC1_CHSEL_Channel_8                                              */
  MDR_ADC_ADC1_CHSEL_Channel_8_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC1_CHSEL_Channel_8_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC1_CHSEL_Channel_8_Enum;

/* ==========================================  MDR_ADC ADC1_CHSEL Channel_9 [9..9]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC1_CHSEL_Channel_9                                              */
  MDR_ADC_ADC1_CHSEL_Channel_9_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC1_CHSEL_Channel_9_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC1_CHSEL_Channel_9_Enum;

/* ========================================  MDR_ADC ADC1_CHSEL Channel_10 [10..10]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC1_CHSEL_Channel_10                                             */
  MDR_ADC_ADC1_CHSEL_Channel_10_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC1_CHSEL_Channel_10_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC1_CHSEL_Channel_10_Enum;

/* ========================================  MDR_ADC ADC1_CHSEL Channel_11 [11..11]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC1_CHSEL_Channel_11                                             */
  MDR_ADC_ADC1_CHSEL_Channel_11_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC1_CHSEL_Channel_11_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC1_CHSEL_Channel_11_Enum;

/* ========================================  MDR_ADC ADC1_CHSEL Channel_12 [12..12]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC1_CHSEL_Channel_12                                             */
  MDR_ADC_ADC1_CHSEL_Channel_12_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC1_CHSEL_Channel_12_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC1_CHSEL_Channel_12_Enum;

/* ========================================  MDR_ADC ADC1_CHSEL Channel_13 [13..13]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC1_CHSEL_Channel_13                                             */
  MDR_ADC_ADC1_CHSEL_Channel_13_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC1_CHSEL_Channel_13_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC1_CHSEL_Channel_13_Enum;

/* ========================================  MDR_ADC ADC1_CHSEL Channel_14 [14..14]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC1_CHSEL_Channel_14                                             */
  MDR_ADC_ADC1_CHSEL_Channel_14_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC1_CHSEL_Channel_14_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC1_CHSEL_Channel_14_Enum;

/* ========================================  MDR_ADC ADC1_CHSEL Channel_15 [15..15]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC1_CHSEL_Channel_15                                             */
  MDR_ADC_ADC1_CHSEL_Channel_15_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC1_CHSEL_Channel_15_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC1_CHSEL_Channel_15_Enum;
...
/* ======================================================  ADC2_CHSEL  ======================================================= */
/* ==========================================  MDR_ADC ADC2_CHSEL Channel_0 [0..0]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_0                                              */
  MDR_ADC_ADC2_CHSEL_Channel_0_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_0_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_0_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_1 [1..1]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_1                                              */
  MDR_ADC_ADC2_CHSEL_Channel_1_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_1_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_1_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_2 [2..2]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_2                                              */
  MDR_ADC_ADC2_CHSEL_Channel_2_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_2_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_2_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_3 [3..3]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_3                                              */
  MDR_ADC_ADC2_CHSEL_Channel_3_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_3_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_3_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_4 [4..4]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_4                                              */
  MDR_ADC_ADC2_CHSEL_Channel_4_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_4_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_4_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_5 [5..5]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_5                                              */
  MDR_ADC_ADC2_CHSEL_Channel_5_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_5_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_5_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_6 [6..6]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_6                                              */
  MDR_ADC_ADC2_CHSEL_Channel_6_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_6_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_6_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_7 [7..7]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_7                                              */
  MDR_ADC_ADC2_CHSEL_Channel_7_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_7_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_7_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_8 [8..8]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_8                                              */
  MDR_ADC_ADC2_CHSEL_Channel_8_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_8_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_8_Enum;

/* ==========================================  MDR_ADC ADC2_CHSEL Channel_9 [9..9]  ========================================== */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_9                                              */
  MDR_ADC_ADC2_CHSEL_Channel_9_Off     = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_9_Selected = 1,    /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_9_Enum;

/* ========================================  MDR_ADC ADC2_CHSEL Channel_10 [10..10]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_10                                             */
  MDR_ADC_ADC2_CHSEL_Channel_10_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_10_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_10_Enum;

/* ========================================  MDR_ADC ADC2_CHSEL Channel_11 [11..11]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_11                                             */
  MDR_ADC_ADC2_CHSEL_Channel_11_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_11_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_11_Enum;

/* ========================================  MDR_ADC ADC2_CHSEL Channel_12 [12..12]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_12                                             */
  MDR_ADC_ADC2_CHSEL_Channel_12_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_12_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_12_Enum;

/* ========================================  MDR_ADC ADC2_CHSEL Channel_13 [13..13]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_13                                             */
  MDR_ADC_ADC2_CHSEL_Channel_13_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_13_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_13_Enum;

/* ========================================  MDR_ADC ADC2_CHSEL Channel_14 [14..14]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_14                                             */
  MDR_ADC_ADC2_CHSEL_Channel_14_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_14_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_14_Enum;

/* ========================================  MDR_ADC ADC2_CHSEL Channel_15 [15..15]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_15                                             */
  MDR_ADC_ADC2_CHSEL_Channel_15_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_15_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_15_Enum;

/* ========================================  MDR_ADC ADC2_CHSEL Channel_30 [30..30]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_30                                             */
  MDR_ADC_ADC2_CHSEL_Channel_30_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_30_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_30_Enum;

/* ========================================  MDR_ADC ADC2_CHSEL Channel_31 [31..31]  ========================================= */
typedef enum {                                  /*!< MDR_ADC_ADC2_CHSEL_Channel_31                                             */
  MDR_ADC_ADC2_CHSEL_Channel_31_Off    = 0,     /*!< Off : Not used in channels switching                                      */
  MDR_ADC_ADC2_CHSEL_Channel_31_Selected = 1,   /*!< Selected : Using in channels switching                                    */
} MDR_ADC_ADC2_CHSEL_Channel_31_Enum;
...
/* =============================================  MDR_BKP REG_0E MODE [12..14]  ============================================== */
typedef enum {                                  /*!< MDR_BKP_REG_0E_MODE                                                       */
  MDR_BKP_0E__MODE__IntFlash_JtagB     = 0,     /*!< IntFlash_JtagB : Execute from internal flash with Jtag_B                  */
  MDR_BKP_0E__MODE__IntFlash_JtagA     = 1,     /*!< IntFlash_JtagA : Execute from internal flash with Jtag_A                  */
  MDR_BKP_0E__MODE__ExtMem_JtagB       = 2,     /*!< ExtMem_JtagB : Execute from external memory with Jtag_B                   */
  MDR_BKP_0E__MODE__ExtMem_JtagOff     = 3,     /*!< ExtMem_JtagOff : Execute from external memory without any Jtag            */
  MDR_BKP_0E__MODE__Uart_PF01          = 6,     /*!< Uart_PF01 : Uart bootloader, pins PF[1:0]                                 */
} MDR_BKP_0E__MODE__Enum;
