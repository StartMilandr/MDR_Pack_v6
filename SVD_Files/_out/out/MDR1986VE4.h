 ...
 *           last modified on Wednesday, 22.01.2020 07:26:05
 */
...
typedef struct {                                /*!< (@ 0x40020000) MDR_RST_CLOCK Structure                                    */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t ADCIU_C3_SEL : 4;          /*!< [7..4] ADCIU_C1 mux output freq devider, [/1, /2, /4 .. /256]             */
      __IOM uint32_t ADC_C3_SEL : 4;            /*!< [11..8] ADC_C1 mux output freq devider, [/1, /2, /4 .. /256]              */
...
#define MDR_RST_CLOCK_ADC_CLOCK_ADCIU_C3_SEL_Pos (4UL)              /*!< MDR_RST_CLOCK ADC_CLOCK: ADCIU_C3_SEL (Bit 4)         */
#define MDR_RST_CLOCK_ADC_CLOCK_ADCIU_C3_SEL_Msk (0xf0UL)           /*!< MDR_RST_CLOCK ADC_CLOCK: ADCIU_C3_SEL (Bitfield-Mask: 0x0f) */
...
/* ======================================  MDR_RST_CLOCK ADC_CLOCK ADCIU_C3_SEL [4..7]  ====================================== */
