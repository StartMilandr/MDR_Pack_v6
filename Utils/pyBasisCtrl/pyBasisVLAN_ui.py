...
################################################################################
## Form generated from reading UI file 'pyBasisVLAN.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btSaveToFile = QPushButton(self.grboxSave)
        self.btSaveToFile.setObjectName(u"btSaveToFile")
        self.btSaveToFile.setMinimumSize(QSize(0, 26))

        self.horizontalLayout.addWidget(self.btSaveToFile)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"VLAN Table", None))
        self.grboxSave.setTitle(QCoreApplication.translate("Form", u"View Table", None))
        self.btSaveToFile.setText(QCoreApplication.translate("Form", u"Save to File...", None))
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Form", u"ForwPorts", None));
