...
################################################################################
## Form generated from reading UI file 'pyVV3_MAC.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.chbxOldClear = QCheckBox(self.gbxDevice)
        self.chbxOldClear.setObjectName(u"chbxOldClear")
        sizePolicy = QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.chbxOldClear.sizePolicy().hasHeightForWidth())
        self.chbxOldClear.setSizePolicy(sizePolicy)

        self.horizontalLayout_2.addWidget(self.chbxOldClear)
        ...
        if (self.tblTableRd.columnCount() < 7):
            self.tblTableRd.setColumnCount(7)
        ...
        if (self.tblCtrl.columnCount() < 5):
            self.tblCtrl.setColumnCount(5)
        __qtablewidgetitem7 = QTableWidgetItem()
        self.tblCtrl.setHorizontalHeaderItem(0, __qtablewidgetitem7)
        __qtablewidgetitem8 = QTableWidgetItem()
        self.tblCtrl.setHorizontalHeaderItem(1, __qtablewidgetitem8)
        __qtablewidgetitem9 = QTableWidgetItem()
        self.tblCtrl.setHorizontalHeaderItem(2, __qtablewidgetitem9)
        __qtablewidgetitem10 = QTableWidgetItem()
        self.tblCtrl.setHorizontalHeaderItem(3, __qtablewidgetitem10)
        __qtablewidgetitem11 = QTableWidgetItem()
        self.tblCtrl.setHorizontalHeaderItem(4, __qtablewidgetitem11)
    ...
    def retranslateUi(self, Form):
        ...
        self.chbxOldClear.setText(QCoreApplication.translate("Form", u"Old Clearing", None))
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Form", u"Addr", None));
        ___qtablewidgetitem2 = self.tblTableRd.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Form", u"HASH", None));
        ___qtablewidgetitem3 = self.tblTableRd.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Form", u"HashInd", None));
        ___qtablewidgetitem4 = self.tblTableRd.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Form", u"MAC", None));
        ...
        ___qtablewidgetitem7 = self.tblCtrl.horizontalHeaderItem(0)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("Form", u"HashInd", None));
        ___qtablewidgetitem8 = self.tblCtrl.horizontalHeaderItem(1)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("Form", u"MAC", None));
        ___qtablewidgetitem9 = self.tblCtrl.horizontalHeaderItem(2)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("Form", u"AGE", None));
        ___qtablewidgetitem10 = self.tblCtrl.horizontalHeaderItem(3)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("Form", u"PORT", None));
        ___qtablewidgetitem11 = self.tblCtrl.horizontalHeaderItem(4)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("Form", u"Apply", None));
    # retranslateUi
